...
// It returns a fake implementation of the DiscoveryClient
// Returns:
//   *discovery.DiscoveryClient
// Example:
//   discoveryClient := fake.Clientset{}.Discovery()
//
// -- Doc autogenerated on 2022-05-12 18:42:24.343390 --
func (c *Clientset) Discovery() discovery.DiscoveryInterface {
	return c.discovery
}

// Tracker is a fake implementation of a Tracker.
// It returns fake objects.
// Returns:
//   * fake.Clientset
//   * fake.Tracker
// Example:
//   clientset, tracker := testing.NewClientsetTracker()
//   k8sclient := clientset.Kubernetes()
//   tracker.AddObj(k8sclient.Core().Services("ns1").Get("svc1", metav1.GetOptions{}))
//
// -- Doc autogenerated on 2022-05-12 18:42:24.343390 --

...
// Example:
//   trident, err := client.TridentV1().TridentOrchestrators()
//
// -- Doc autogenerated on 2022-05-12 18:43:04.890052 --
...
// setConfigDefaults sets default values for rest.Config
// It returns an error if the supplied config is invalid.
// Parameters:
//     config - the rest.Config object to set defaults for
// Returns:
//     error - an error if the supplied config is invalid
// Example:
//     config := &rest.Config{}

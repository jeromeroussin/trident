...
// It returns an error if Trident is not installed.
// Returns:
//   - error if Trident is not installed or if an error occurs during uninstall
// Example:
...
//   	}
//
// -- Doc autogenerated on 2022-05-12 19:02:27.838010 --
...
// Returns:
//   error: nil if uninstall was successful, otherwise an error object
// Example:
...
// It returns an error if the uninstall fails.
// Returns:
//   error - error if uninstall fails
// Example:
...
// Returns:
//   error - if the CRDs cannot be removed
// Example:

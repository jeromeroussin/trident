...
// Returns:
//   error: if the uninstall fails
// Example:
//   err := i.UninstallTrident()
//   if err != nil {
//       log.Errorf("Uninstall failed: %v", err)
//   }
//
// -- Doc autogenerated on 2022-05-12 21:12:31.321270 --
...
// It returns an error if the uninstall fails
// Returns:
//   error: error object if the uninstall fails
// Example:
//   err := i.UninstallCSIPreviewTrident()
//
// -- Doc autogenerated on 2022-05-12 21:12:31.321270 --
...
// UninstallLegacyTrident removes the legacy Trident deployment and RBAC objects
// It returns an error if the uninstall fails
// Returns:
//   error: any errors encountered during uninstall
// Example:
//   err := i.UninstallLegacyTrident()
//   if err != nil {
//       return err
//   }
//
...
// It returns an error if any CRD cannot be deleted.
// Returns:

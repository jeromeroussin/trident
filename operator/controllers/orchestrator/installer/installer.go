...
// It returns a TridentInstaller interface
...
// Returns:
//   TridentInstaller - Trident installer
//   error - error if the installer cannot be created
// Example:
...
//    }
//
// -- Doc autogenerated on 2022-05-12 18:45:31.327808 --
...
// logFormatPrechecks checks that the log format is valid
// It returns an error if the log format is not valid
// Returns:
//   error: if the log format is not valid
// Example:
//   returnError := i.logFormatPrechecks()
//   if returnError != nil {
...
// It returns the TridentOrchestratorSpecValues, the version of Trident installed, and an error
// Parameters:
//   cr - the TridentOrchestrator CR
//   currentInstallationVersion - the version of Trident currently installed
//   k8sUpdateNeeded - true if the K8s version has changed since the last installation
// Returns:
//   TridentOrchestratorSpecValues - the values from the CR that were used to install Trident
...
// Parameters:
//   controllingCRDetails - map of the controlling CR's details
//   labels - map of labels to apply to the K8s (beta) CSI driver
//   shouldUpdate - whether or not to update the K8s (beta) CSI driver
// Returns:
...
//   labels: map of labels to be applied to the CSI driver
//   shouldUpdate: true if the CSI driver should be updated, false otherwise
// Returns:
//   error: nil if successful, error object otherwise
// Example:
//   err := i.createOrPatchK8sCSIDriver(controllingCRDetails, labels, shouldUpdate)
//
// -- Doc autogenerated on 2022-05-12 18:45:31.327808 --
...
//   labels - the labels to apply to the RBAC objects
//   shouldUpdate - whether to update existing objects
// Returns:
//   newServiceAccount - whether a new service account was created
//   returnError - any error encountered
// Example:
//   newServiceAccount, returnError := i.createRBACObjects(controllingCRDetails, labels, true)
//
// -- Doc autogenerated on 2022-05-12 18:45:31.327808 --
...
// createTridentInstallationNamespace creates the namespace for Trident's installation
...
// It returns a boolean indicating whether the service account was created, and an error
// Parameters:
//   controllingCRDetails - a map containing the controlling CR's name and namespace
//   labels - a map containing the labels to be applied to the service account
//   shouldUpdate - a boolean indicating whether the service account should be updated
// Return values:
//   bool - a boolean indicating whether the service account was created
//   error - an error indicating whether the function succeeded or failed
// Returns:
//   bool - a boolean indicating whether the service account was created
//   error - an error indicating whether the function succeeded or failed
// Example:
...
// It returns an error if the operation fails.
// Parameters:
//   controllingCRDetails - details about the controlling CR
//   labels - labels to apply to the cluster role
//   shouldUpdate - whether the cluster role should be updated
// Returns:
//   error - error if the operation fails
// Example:
//   controllingCRDetails := map[string]string{"app": "trident"}
//   labels := map[string]string{"app": "trident"}
//   err := createOrPatchTridentClusterRole(controllingCRDetails, labels, true)
//
// -- Doc autogenerated on 2022-05-12 18:45:31.327808 --
...
// Parameters:
//   controllingCRDetails - the details of the controlling CR
//   labels - the labels to apply to the Trident cluster role binding
//   shouldUpdate - true if the Trident cluster role binding should be updated, false otherwise
// Returns:
//   error - error if the operation fails
// Example:
...
// It returns an error if the SCC could not be created or patched.
// Parameters:
//   controllingCRDetails: a map of the controlling CR's name and namespace
//   labels: a map of labels to apply to the SCC
//   shouldUpdate: whether or not the SCC should be updated
// Returns:
//   error: nil if the SCC was created or patched successfully, or an error if the SCC could not be created or patched
// Example:
//   labels := map[string]string{
//     "app": "trident",
//   }
//   err := createOrPatchTridentOpenShiftSCC(map[string]string{}, labels, false)
//   if err != nil {
//     log.Errorf("Unable to create Trident OpenShift SCC, err: %v", err)
//     return err
//   }
//
// -- Doc autogenerated on 2022-05-12 18:45:31.327808 --
...
// createAndEnsureCRDs creates the Trident CRDs and ensures they are ready.
// Returns:
//   error: nil if successful, else a descriptive error
// Example:
//   err := i.createAndEnsureCRDs()
//   if err != nil {
//       // handle error
//   }
//
...
//   shouldUpdate - true if the Trident pod security policy should be updated
// Returns:
//   error - an error if the operation fails
// Example:
//   err := createOrPatchTridentPodSecurityPolicy(controllingCRDetails, labels, shouldUpdate)
//
// -- Doc autogenerated on 2022-05-12 18:45:31.327808 --
...
//   labels - map of labels to apply to the Trident service
//   shouldUpdate - whether or not the Trident service should be updated
// Returns:
//   error - error if the Trident service could not be created or patched
// Example:
...
// It returns an error if the secret could not be created or patched.
// Parameters:
//   controllingCRDetails - a map of labels and annotations to add to the secret
//   labels - a map of labels to add to the secret
//   shouldUpdate - true if the secret should be updated if it already exists
// Returns:
//   error - nil if the secret was created or patched successfully
// Example:
//   controllingCRDetails := map[string]string{
//		"netapp.io/trident-version": "v1.0",
//   }
//   labels := map[string]string{
//		"netapp.io/trident-version": "v1.0",
//   }
//   err := i.createOrPatchTridentProtocolSecret(controllingCRDetails, labels, true)
//
// -- Doc autogenerated on 2022-05-12 18:45:31.327808 --
...
// Example:
//   err := i.createOrPatchTridentDeployment(controllingCRDetails, labels, true, true)
//
// -- Doc autogenerated on 2022-05-12 18:45:31.327808 --
func (i *Installer) createOrPatchTridentDeployment(
...
// Parameters:
//   controllingCRDetails - a map containing the name and namespace of the controlling CR
//   labels - a map containing the labels to be applied to the daemonset
//   shouldUpdate - true if the daemonset should be updated
//   newServiceAccount - true if a new service account should be created
// Returns:
//   error - an error if the daemonset cannot be created or patched
// Example:
//   error := i.createOrPatchTridentDaemonSet(controllingCRDetails, labels, shouldUpdate, newServiceAccount)
//
//
// -- Doc autogenerated on 2022-05-12 18:45:31.327808 --
func (i *Installer) createOrPatchTridentDaemonSet(
...
// waitForTridentPod waits for the Trident pod to be running.
// It returns the pod if it is running, or an error if it is not.
// Returns:
//   * Pod if running
//   * Error if not running
// Example:
//   pod, err := i.waitForTridentPod()
//   if err != nil {
...
// It returns an error if the REST interface is not available within the timeout.
// Parameters:
//   tridentPodName - the name of the Trident pod
// Returns:
//   error - an error if the REST interface is not available within the timeout
// Example:
//   err := i.waitForRESTInterface("trident-backend-pod-name")
//   if err != nil {
//		return err
//   }
//

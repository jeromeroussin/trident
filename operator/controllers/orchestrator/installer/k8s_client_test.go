...
// It checks for any standard log output and disables it
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --
...
// - the function returns an error when the k8s client returns an error
// - the function returns an error when the CRD is not in the expected state
// - the function returns nil when the CRD is in the expected state
...
// It checks for the following conditions:
// 1. K8s client errors
// 2. No transient pods found
// 3. Transient pods found but not removed
// 4. Transient pods found and removed
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --
...
// It checks that the function returns nil when the k8s client returns no error
// It returns nil when the k8s client returns no error
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --
...
// It checks that the function returns the expected error when the k8s client returns an error
// It also checks that the function returns nil when there are no beta csi driver crs to delete
// It also checks that the function returns nil when there are valid beta csi driver crs to delete
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --
...
// TestPutCSIDriver tests the PutCSIDriver function
// It checks that the correct k8s client calls are made
...
// an error.
// It returns the correct error when the k8s client returns an error, and that
// it returns nil when the k8s client does not return an error.
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --
...
// It checks the following cases:
// 1. No CSI driver CRs are passed in
// 2. A k8s call error occurs
// 3. Valid CSI driver CRs are passed in
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --
...
// It checks for the following conditions:
// 1. If the function returns the correct current cluster role
// 2. If the function returns the correct unwanted cluster roles
// 3. If the function returns the correct create cluster role boolean
// 4. If the function returns the correct error
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --
...
// It checks that the function returns the expected error when the k8s client returns an error
// It checks that the function returns nil when the k8s client does not return an error
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --
...
// It checks the following cases:
// 1. No cluster roles to delete
// 2. Error returned from k8s client
// 3. Valid cluster roles to delete
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --
...
// 2. Expect to pass with no cluster role binding found and no k8s error
// 3. Expect to pass with valid current cluster role binding found and no k8s error
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --
...
// It checks that the function returns an error when it is unable to get the list of cluster role bindings
// It checks that the function returns nil when it is able to get the list of cluster role bindings
// It checks that the function returns an error when it is unable to delete the cluster role bindings
// It checks that the function returns nil when it is able to delete the cluster role bindings
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --
...
// 1. k8s error
// 2. no daemonset found
// 3. current daemonset found
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --
...
// It checks that the function returns the expected error
// It also checks that the k8s client is called with the expected arguments
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --
...
// It checks that the function returns the correct error when the k8s client
// returns an error. It also checks that the function returns nil when the
// k8s client returns a list of daemonsets and when it returns an empty list.
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --
...
// It checks the following cases:
// - when GetDeploymentsByLabel fails
// - when GetDeploymentsByLabel returns no deployments
// - when GetDeploymentsByLabel succeeds but RemoveMultipleDeployments fails
// - when GetDeploymentsByLabel succeeds and RemoveMultipleDeployments succeeds
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --
...
// It checks the following cases:
// 1. Expect to fail with k8s error
// 2. Expect to pass with no pod security policies found and no k8s error
// 3. Expect to pass with valid current pod security policies found and no k8s error
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --
...
// It checks the following cases:
// 1. Create a PodSecurityPolicy and no k8s error occurs
// 2. Create a PodSecurityPolicy and a k8s error occurs
// 3. Update a PodSecurityPolicy and no k8s error occurs
// 4. Update a PodSecurityPolicy and a k8s error occurs
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --
...
// It checks that the function returns an error when the k8s client returns policies but fails to delete them
// It checks that the function returns nil when the k8s client returns policies and succeeds in deleting them
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --
...
// It checks that the function returns the correct error when
// GetSecretsByLabel fails, when GetSecretsByLabel returns no secrets,
// when DeleteSecret fails, and when DeleteSecret succeeds
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --
...
// It checks that the function returns the expected error when the k8s client returns an error
// It checks that the function returns nil when the k8s client returns no services
// It checks that the function returns an error when the k8s client returns services but fails to delete them
// It checks that the function returns nil when the k8s client returns services and successfully deletes them
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --
...
// It checks that the function returns the correct error code based on the
// input and the k8s client calls
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --
...
// It checks for errors and ensures that the correct k8s client calls are made
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --
...
// It checks the following cases:
// - when GetServiceAccountsByLabel fails
// - when GetServiceAccountsByLabel succeeds but RemoveMultipleServiceAccounts fails
// - when GetServiceAccountsByLabel succeeds and RemoveMultipleServiceAccounts succeeds
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --
...
// TestGetTridentOpenShiftSCCInformation tests the GetTridentOpenShiftSCCInformation method
// It checks that the method returns the correct values for the following scenarios:
// - k8s error
...
// It checks that the function returns the expected error and output
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --
...
// It checks that the correct snapshot crd version is returned based on the deployment
// and the snapshot crd version
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --
...
// It checks for the following conditions:
// 1. GetStatefulSetsByLabel fails
// 2. GetStatefulSetsByLabel returns no statefulsets
// 3. GetStatefulSetsByLabel succeeds but RemoveMultipleStatefulSets fails
// 4. GetStatefulSetsByLabel succeeds and RemoveMultipleStatefulSets succeeds
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --
...
// It checks the following cases:
// 1. create OpenShift SCCs and no k8s error occurs when removing Trident users from OpenShiftSCC
// 2. create OpenShift SCCs and a k8s error occurs when removing Trident users from OpenShiftSCC
// 3. create OpenShift SCCs and no k8s error occurs
// 4. create OpenShift SCCs and a k8s error occurs
// 5. update OpenShift SCCs and no k8s error occurs
// 6. update OpenShift SCCs and a k8s error occurs
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --
...
// It checks for the following cases:
// 1. No stateful sets are passed in
// 2. A k8s call error occurs
// 3. Valid stateful sets are passed in
//
// -- Doc autogenerated on 2022-05-12 18:53:38.819789 --

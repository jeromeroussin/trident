...
// Example:
//   defaultInformer(kubernetes.NewForConfig(config), time.Duration(0 * time.Second), cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc})
//
// -- Doc autogenerated on 2022-05-12 19:09:28.836842 --
func (f *tridentProvisionerInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
// Informer is used to inform about resources.
// It returns a cache.SharedIndexInformer.
// Returns:
//   A cache.SharedIndexInformer
// Example:
//   informer := f.TridentInformer().TridentProvisioner().Informer()
//   indexer := informer.GetIndexer()
//   indexer.Add(&netappv1.TridentProvisioner{ObjectMeta: metav1.ObjectMeta{Name: "foo"}})
//   obj, exists, err := indexer.GetByKey("foo")
//
// -- Doc autogenerated on 2022-05-12 19:09:28.836842 --
...
// It returns TridentProvisionerLister.
// Returns:
//   * TridentProvisionerLister
// Example:
//   lister := listers.NewTridentProvisionerLister(indexer)
//
// -- Doc autogenerated on 2022-05-12 19:09:28.836842 --

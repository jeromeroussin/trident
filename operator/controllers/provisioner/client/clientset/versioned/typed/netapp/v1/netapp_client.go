...
// Returns:
//      a TridentProvisionerInterface
// Example:
//      c := v1.NewTridentV1Client("", "", nil)
//      c.TridentProvisioners("trident").Get("trident")
//
// -- Doc autogenerated on 2022-05-12 21:18:04.957298 --
...
// Parameters:
//   config: the configuration to set the defaults for
// Returns:

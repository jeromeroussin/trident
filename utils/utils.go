...
//    >> 0
//
// -- Doc autogenerated on 2022-05-12 15:04:08.156871 --
func (s sizeUnit2) Len() int {
	return len(s)
}

// Swap implements the Swap method in sort.Interface
// Parameters:
...
//   none
// Example:
//   sizeUnit2 := []SizeUnit{SizeUnit{Size: 1}, SizeUnit{Size: 2}}
//   sizeUnit2.Swap(0,1)
//
// -- Doc autogenerated on 2022-05-12 15:04:08.156871 --
...
// Less is used to sort the sizeUnit2 slice
// It returns true if the length of the first string is greater than the length of the second string
// Parameters:
//   i: index of the first string
//   j: index of the second string
// Returns:
//   true if the length of the first string is greater than the length of the second string
// Example:
//   Less(2, 3)
//   returns true if the length of the string at index 2 is greater than the length of the string at index 3
//
// -- Doc autogenerated on 2022-05-12 15:04:08.156871 --
...
// Len returns the length of the sizeUnit10
// Returns:
//    int: the length of the sizeUnit10
// Example:
//    s := sizeUnit10{1,2,3}
//    fmt.Println(s.Len())
//
...
// Less is used to sort the sizeUnit10 slice
// It returns true if the length of the first string is greater than the length of the second string
// Parameters:
//   i - index of the first string
//   j - index of the second string
...
//   true if the length of the first string is greater than the length of the second string
// Example:
//   sizeUnit10{ "1", "10", "100", "1000" }.Less(2, 3)
//   returns true
//
// -- Doc autogenerated on 2022-05-12 15:04:08.156871 --
...
//   redactBody: whether to redact the body of the HTTP request
// Returns:
//   None
// Example:
//   LogHTTPRequest(request, requestBody, true)
//
// -- Doc autogenerated on 2022-05-12 15:04:08.156871 --
...
// LogHTTPResponse logs the HTTP response
// Parameters:
//   ctx - context
//   response - HTTP response
//   responseBody - HTTP response body
//   redactBody - if true, the body will be redacted
// Returns:
//   none
// Example:
//   LogHTTPResponse(ctx, response, responseBody, true)
//
// -- Doc autogenerated on 2022-05-12 15:04:08.156871 --
...
// Example:
//   e := utils.HTTPError{Status: "400 Bad Request"}
//   fmt.Println(e.Error())
//
// -- Doc autogenerated on 2022-05-12 15:04:08.156871 --
...
// NewHTTPError returns an HTTPError if the response status code is >= 300
// Parameters:
//    response *http.Response
// Returns:
//    *HTTPError
...
// GetYAMLTagWithSpaceCount returns the indentation of a tag in a YAML file.
// It returns the tag with the indentation and the number of spaces.
// Parameters:
//     text: The text of the YAML file.
//     tagName: The name of the tag to search for.
// Returns:
//     string: The tag with the indentation.
//     int: The number of spaces in the indentation.
// Example:
//     tag, indentation := utils.GetYAMLTagWithSpaceCount(text, "tagName")
//
// -- Doc autogenerated on 2022-05-12 15:04:08.156871 --
...
// Parameters:
//   text: the text to count spaces before
// Returns:
//   the number of spaces before the text
// Example:
//   CountSpacesBeforeText("   Hello") returns 3
//
// -- Doc autogenerated on 2022-05-12 15:04:08.156871 --
...
// RunningInContainer returns true if the code is running in a container
// Returns:
//     bool
// Example:
//     utils.RunningInContainer()
//
// -- Doc autogenerated on 2022-05-12 15:04:08.156871 --
...
// ValidateOctalUnixPermissions validates that the given string is a valid octal unix permissions value
// It returns an error if the given string is not a valid octal unix permissions value
// Parameters:
//    perms: string to validate
// Returns:
//    error: nil if the given string is a valid octal unix permissions value, otherwise an error
// Example:
//    err := utils.ValidateOctalUnixPermissions("0755")
//    if err != nil {
//       handle error
//    }
//
...
// GenerateVolumePublishName generates the volume publish name
// It returns the volumeID.nodeID
// Parameters:
//   volumeID: the volume ID
//   nodeID: the node ID
// Returns:
//   string: the volume publish name
// Example:
//   volumeID := "8e0f9c1c-b3ac-40f5-8c7a-d9b68a9a95a2"
//   nodeID := "node1"
//   volumePublishName := utils.GenerateVolumePublishName(volumeID, nodeID)
//   // volumePublishName is "8e0f9c1c-b3ac-40f5-8c7a-d9b68a9a95a2.node1"
//
// -- Doc autogenerated on 2022-05-12 15:04:08.156871 --
...
// RedactSecretsFromString redacts secrets from a string
// It returns a string with the secrets redacted
// Parameters:
//   stringToSanitize - the string to sanitize
//   replacements - a map of secrets to redact and their replacement values
//   useRegex - whether or not to use regex to redact the secrets
// Returns:
//   string - the sanitized string
// Example:
//   stringToSanitize := "secret1=foo secret2=bar"
//   replacements := map[string]string{
//     "secret1=.*": "secret1=********",
//     "secret2=.*": "secret2=********",
//   }
//   useRegex := true
//   RedactSecretsFromString(stringToSanitize, replacements, useRegex)
//   // secret1=******** secret2=********
//
// -- Doc autogenerated on 2022-05-12 15:04:08.156871 --

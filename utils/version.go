...
//
// If semver is true, the version must be a semantic version.
// If datever is true, the version must be a date version.
// If neither is true, the version must be at least a major.minor version.
// It returns an error if the version string is invalid.
// Parameters:
//     str: the version string to parse
//     semver: whether to parse as a semantic version
//     datever: whether to parse as a date version
// Returns:
//     *Version: the parsed version
//     error: an error if the version string is invalid
// Example:
//     version, err := parse("1.2.3", true, false)
//     if err != nil {
//         fmt.Println(err)
//     }
//     fmt.Println(version)
//
// -- Doc autogenerated on 2022-05-12 15:16:15.188335 --
...
// MajorVersion returns the major version of the version string
// Returns:
//   uint: The major version
// Example:
//   v := &Version{components: []uint{1, 2, 3, 4}}
//   v.MajorVersion() returns 1
//
// -- Doc autogenerated on 2022-05-12 15:16:15.188335 --
...
// MajorVersionString returns the major version as a string
// Returns:
//   string - major version
// Example:
//   version := NewVersion("1.2.3")
//   version.MajorVersionString() // "1"
//
// -- Doc autogenerated on 2022-05-12 15:16:15.188335 --
...
// MinorVersion returns the minor version of the version string
// Returns:
//    uint - minor version
// Example:
//    v := NewVersion("1.2.3")
...
// MinorVersionString returns the minor version as a string
// Returns:
//   string: minor version
// Example:
//   v := utils.NewVersion("3.5.0")
//   v.MinorVersionString()
// Returns:
//   "5"
//
// -- Doc autogenerated on 2022-05-12 15:16:15.188335 --
...
// PatchVersion returns the patch version of the version.
// Returns:
//   0 if the version is not in the form of major.minor.patch
// Example:
//   v := Version{[]uint{1, 2, 3}}
//   v.PatchVersion()
//   Output: 3
//
// -- Doc autogenerated on 2022-05-12 15:16:15.188335 --
...
// PreRelease returns the pre-release string of the version.
// Returns:
//   string: the pre-release string of the version
// Example:
//   v := NewVersion("1.0.0-alpha")
...
// ToMajorMinorVersion returns a new Version with the patch version set to 0.
// Returns:
//   *Version: A new Version with the patch version set to 0.
// Example:
//   version := MustParseGeneric("1.2.3")
//   version.ToMajorMinorVersion() // Returns 1.2.0
//
// -- Doc autogenerated on 2022-05-12 15:16:15.188335 --
...
// ToMajorMinorString returns a string representation of the major and minor version
// Returns:
//   "major.minor"
// Example:
//   v := NewVersion("1.2.3")
//   v.ToMajorMinorString() // "1.2"
//
// -- Doc autogenerated on 2022-05-12 15:16:15.188335 --

...
// testOne tests a single version string.
// It returns an error if the version string does not round-trip,
// or if it is not ordered correctly relative to the previous version string.
// Parameters:
//   v: the version to test
//   item: the test item for the version
//   prev: the previous test item
// Returns:
//   error: an error if the version does not round-trip or is not ordered correctly
// Example:
//   var v *Version
//   var err error
...
//   }
//
// -- Doc autogenerated on 2022-05-12 15:19:23.516989 --
...
// TestSemanticVersions tests the ParseSemantic function.
// It checks that the parsed version is correct, and that
// the ordering of the versions is correct.
//
// -- Doc autogenerated on 2022-05-12 15:19:23.516989 --
...
// TestBadSemanticVersions tests that invalid semver strings are rejected.
// It checks that the parser is not too permissive, and that it rejects
...
// TestDateVersions tests the date version parsing
// It checks that the parsed version is correct, and that
...
// TestBadDateVersions tests that invalid date versions are rejected.
// It checks that all of the following are rejected:
// - invalid format
// - invalid month
// - invalid pre-release
...
// TestGenericVersions tests that the generic version parser works as expected.
// It checks that the generic parser parses the same strings as the semantic
// parser, and that it parses some additional strings.
//
// -- Doc autogenerated on 2022-05-12 15:19:23.516989 --
...
// TestBadGenericVersions tests that invalid versions fail to parse
// It checks that the error is not nil
//
// -- Doc autogenerated on 2022-05-12 15:19:23.516989 --

...
// IPv6Check returns true if the IP is IPv6
// Parameters:
//   ip - IP address
// Returns:
//   true if the IP is IPv6
// Example:
//   IPv6Check("fe80::f816:3eff:fe20:57c3")
//
// -- Doc autogenerated on 2022-05-12 14:39:06.443870 --
...
// SetChrootPathPrefix sets the chroot path prefix
// Parameters:
//   prefix - the chroot path prefix
// Returns:
//   none
// Example:
//   SetChrootPathPrefix("/var/lib/trident")
//
// -- Doc autogenerated on 2022-05-12 14:39:06.443870 --
...
// AttachNFSVolume publishes an NFS volume to the host
// It returns an error if the volume could not be published.
// Parameters:
//    name: the volume name
//    mountpoint: the directory where the volume will be mounted
//    publishInfo: the volume publish information
// Returns:
//    error: nil if successful, or an error if the volume could not be published
// Example:
//    err := utils.AttachNFSVolume(ctx, "vol1", "/mnt/vol1", &utils.VolumePublishInfo{
//			NfsServerIP:   "10.63.0.1",
//			NfsPath:       "/nfsvol1",
//			MountOptions:  "rw",
//    })
//
...
// AttachBlockOnFileVolume attaches a block-on-file volume to the host.
//
// If a mountPath is specified, the device will be mounted at mountPath/volumeMountDir.
// If a mountPath is not specified, the device will not be mounted.
// It returns the device name and the mountpoint.
// Parameters:
//   ctx - context
//   mountPath - the path to mount the device
//   publishInfo - the volume publish information
// Returns:
//   deviceName - the device name
//   deviceMountpoint - the device mountpoint
//   err - error if any
// Example:
//   deviceName, deviceMountpoint, err := AttachBlockOnFileVolume(ctx, "", &VolumePublishInfo{...})
//
// -- Doc autogenerated on 2022-05-12 14:39:06.443870 --
...
// DetachBlockOnFileVolume detaches a loop device from a file
// It returns an error if the loop device is not attached to the file
// Parameters:
//   ctx - the context
//   loopDevice - the loop device to detach
//   loopFile - the file to detach from
// Returns:
//   error - any error encountered
// Example:
//   err := DetachBlockOnFileVolume(ctx, "/dev/loop0", "/var/lib/trident/block-volumes/test-volume")
//
// -- Doc autogenerated on 2022-05-12 14:39:06.443870 --
...
// logInToPortals logs in to the specified portals using CHAP.
// It returns true if it was able to log in to at least one portal.
// Parameters:
//   ctx - context
//   bkPortalsToLogin - list of portals to login to
//   publishInfo - volume publish information
//   loggedIn - true if already logged in to at least one portal
// Returns:
//   loggedIn - true if logged in to at least one portal
// Example:
//   loggedIn := logInToPortals(ctx, bkPortalsToLogin, publishInfo, loggedIn)
//
// -- Doc autogenerated on 2022-05-12 14:39:06.443870 --
...
// expandFilesystem expands the filesystem on the given mount point
// It returns the new size of the filesystem
// Parameters:
//   ctx: context
//   cmd: command to execute
//   cmdArguments: arguments to the command
//   tmpMountPoint: mount point of the filesystem to expand
// Returns:
//   int64: size of the filesystem after expansion
//   error: any error encountered
// Example:
//   newSize, err := osutils.expandFilesystem(ctx, "resize2fs", "/dev/sdb1", "/tmp/foo")
//
// -- Doc autogenerated on 2022-05-12 14:39:06.443870 --
...
// ISCSIRescanDevices rescan iSCSI devices
// It returns an error if the device is not large enough after rescanning
// Parameters:
//   ctx: context
//   targetIQN: the IQN of the iSCSI target
//   lunID: the LUN ID of the iSCSI target
//   minSize: the minimum size of the iSCSI device
// Returns:
//   error: nil if no error occurred
// Example:
//   err := ISCSIRescanDevices(ctx, "iqn.2010-10.org.openstack:volume-ebd8e5f7-e0e3-4f9b-8c1d-e1a5d20f5d2f", 0, 10737418240)
//
// -- Doc autogenerated on 2022-05-12 14:39:06.443870 --
...
// reloadMultipathDevice reloads a multipath device.
// It returns an error if the reload fails.
// Parameters:
//   ctx - context for logging
//   multipathDevice - the multipath device to reload
// Returns:
//   error - error if the reload fails
// Example:
//   err := reloadMultipathDevice(ctx, "3600a098038303837b000000000000001")
//
// -- Doc autogenerated on 2022-05-12 14:39:06.443870 --
...
// IsNFSShareMounted checks if the given NFS export is mounted at the given mountpoint
// It returns true if the export is mounted at the given mountpoint
// Parameters:
//   exportPath: the NFS export to check
//   mountpoint: the mountpoint to check
// Returns:
//   bool: true if the export is mounted at the given mountpoint
//   error: any error encountered
// Example:
//   mounted, err := IsNFSShareMounted(ctx, "server:/vol/vol1", "/mnt/vol1")
//   if err != nil {
//     log.Fatal(err)
//   }
//   if mounted {
//     log.Printf("NFS Share is mounted.")
//   } else {
//     log.Printf("NFS Share is not mounted.")
//   }
//
// -- Doc autogenerated on 2022-05-12 14:39:06.443870 --
...
// updateDiscoveryDb updates the discovery database with the given key and value
// It returns an error if the discovery database could not be updated
// Parameters:
//   ctx - context
//   tp - portal
//   iface - interface
...
//   value - value
// Returns:
//   error - error if the discovery database could not be updated
// Example:
//   err := updateDiscoveryDb(ctx, "192.168.0.1:3260", "default", "iface.iscsi_ifacename", "eth0")
//
// -- Doc autogenerated on 2022-05-12 14:39:06.443870 --
...
// getLoopDeviceInfo returns a list of loop devices
// Parameters:
//   ctx: The context for the request
// Returns:
//   []LoopDevice: A list of loop devices
//   error: Any error encountered
// Example:
//   loopDevices, err := getLoopDeviceInfo()
//
// -- Doc autogenerated on 2022-05-12 14:39:06.443870 --
...
// GetLoopDeviceAttachedToFile returns the loop device attached to the specified file
// Parameters:
//   ctx - context
//   loopFile - path to the loop file
// Returns:
//   bool - true if the loop device is attached to the specified file
//   *LoopDevice - the loop device
//   error - any error encountered
// Example:
//   attached, device, err := GetLoopDeviceAttachedToFile(ctx, "/dev/loop0")
//   if err != nil {
//       return err
//   }
//   if attached {
//       fmt.Printf("Loop device %s is attached to file %s\n", device.Name, device.BackFile)
//   } else {
//       fmt.Printf("No loop device is attached to file %s\n", loopFile)
//   }
//
// -- Doc autogenerated on 2022-05-12 14:39:06.443870 --
...
// GetAllLoopDeviceBackFiles returns a list of all loop device back-files
// Parameters:
//   ctx - logging context
// Returns:
//   []string - list of all loop device back-files
//   error - any error encountered
// Example:
//   deviceBackFiles, err := utils.GetAllLoopDeviceBackFiles(ctx)
//   if err != nil {
//       return err
//   }
//
...
// IsLoopDeviceAttachedToFile checks if a loop device is attached to a file
// It returns true if the loop device is attached to the file
// Parameters:
//   ctx: context.Context object
//   loopDevice: loop device name
//   loopFile: file name
// Returns:
//   bool: true if the loop device is attached to the file
//   error: error object if an error occurred
// Example:
//   loopDevices, err := osutils.GetLoopDeviceInfo(ctx)
//   if err != nil {
//       return err
//   }
//   for _, loopDevice := range loopDevices {
//       isAttached, err := osutils.IsLoopDeviceAttachedToFile(ctx, loopDevice.Name, loopFile)
//       if err != nil {
//           return err
//       }
//       if isAttached {
...
// ResizeLoopDevice resizes the loop device to the required size
// It returns an error if the loop device is not resized to the required size
// Parameters:
//    ctx: context.Context object
//    loopDevice: the loop device to resize
//    loopFile: the loop file to resize
//    requiredBytes: the required size in bytes
// Returns:
//    error: nil if successful, error if not
// Example:
//    err := ResizeLoopDevice(ctx, "/dev/loop0", "/tmp/iscsi-test.img", 10737418240)
//    if err != nil {
//       fmt.Println("Failed to resize loop device")
//    }
//
// -- Doc autogenerated on 2022-05-12 14:39:06.443870 --
...
// configureISCSITarget configures the iSCSI target with the specified name and value
// It returns an error if the command fails
// Parameters:
//    ctx - context for logging
//    iqn - IQN of the target
//    portal - portal of the target
//    name - name of the target configuration
//    value - value of the target configuration
// Returns:
//    error - error if the command fails
// Example:
//    err := configureISCSITarget(ctx, iqn, portal, "node.conn[0].startup", "automatic")
//
// -- Doc autogenerated on 2022-05-12 14:39:06.443870 --
...
// EnsureISCSISessions ensures that the iSCSI target is logged in to all portals
// It returns true if a session was established with at least one portal
// Parameters:
//   targetIQN: the IQN of the iSCSI target
//   portalsIps: the IP addresses of the iSCSI portals
//   iface: the interface to use for iSCSI
// Returns:
//   bool: true if a session was established with at least one portal
// Example:
//   EnsureISCSISessions(ctx, "iqn.2003-01.org.linux-iscsi.target1", []string{"192.168.1.10", "192.168.1.11"}, "eth0")
//   EnsureISCSISessions(ctx, "iqn.2003-01.org.linux-iscsi.target1", []string{"192.168.1.10", "192.168.1.11"}, "")
//
// -- Doc autogenerated on 2022-05-12 14:39:06.443870 --
...
// EnsureISCSISessionsWithPortalDiscovery ensures that all the hostDataIPs have an iSCSI session
// with the portal discovery
// It returns an error if any of the hostDataIPs fail to have an iSCSI session
// Parameters:
//   hostDataIPs: list of host data IPs
// Returns:
//   error: nil if all the hostDataIPs have an iSCSI session with the portal discovery
// Example:
//   if err := utils.EnsureISCSISessionsWithPortalDiscovery(ctx, []string{"10.63.11.1", "10.63.11.2"}); nil != err {
//       return err
//   }
//
// -- Doc autogenerated on 2022-05-12 14:39:06.443870 --
...
// EnsureISCSISessionWithPortalDiscovery ensures that an iSCSI session exists for the specified portal
// If no session exists, it will run discovery and log in to the target
// It returns an error if the session could not be established
// Parameters:
//   ctx - context
//   hostDataIP - IP address of the iSCSI portal
// Returns:
//   error - error if session could not be established
// Example:
//   err := utils.EnsureISCSISessionWithPortalDiscovery(ctx, "192.168.1.2")
//
// -- Doc autogenerated on 2022-05-12 14:39:06.443870 --
...
// execIscsiadmCommandRedacted executes an iscsiadm command with the provided args,
// and redacts any secrets in the output.
// It returns the output of the command and any error encountered.
// Parameters:
//   ctx: context for the command
//   args: arguments to the command
//   secretsToRedact: map of secrets to redact from the output
// Returns:
//   output of the command
//   error encountered
// Example:
//   output, err := execIscsiadmCommandRedacted(ctx, []string{"-m", "session", "-P", "3"},
...
// execCommandRedacted executes a command and returns the output.
// It also redacts any secrets passed in the args.
// It returns the output and error.
// Parameters:
//   ctx - context
//   name - name of the command to execute
//   args - arguments to the command
//   secretsToRedact - map of secrets to redact
// Returns:
//   []byte - output of the command
//   error - error
// Example:
//   output, err := execCommandRedacted(ctx, "ls", []string{"-l"}, nil)
//
// -- Doc autogenerated on 2022-05-12 14:39:06.443870 --
...
// If the command times out, the process is killed and an error is returned.
// It returns the output of the command and an error.
// Parameters:
//   ctx: context
//   name: command name
//   timeoutSeconds: timeout in seconds
//   logOutput: whether to log the output
//   args: command arguments
// Returns:
//   output: command output
//   error: error
// Example:
//   out, err := execCommandWithTimeout(ctx, "ls", 10, true, "-l", "/tmp")
//
// -- Doc autogenerated on 2022-05-12 14:39:06.443870 --
...
// sanitizeString removes xterm control characters and trailing newlines
...
// listAllISCSIDevices lists all iSCSI devices
// Parameters:
//   ctx - context
// Returns:
//   none

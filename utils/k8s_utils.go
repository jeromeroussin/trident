...
// GetDeviceNameFromMount returns the device name and reference count for a given mount path.
// Parameters:
//   mountpath: The mount path to look up.
// Returns:
//   device: The device name.
//   refCount: The number of references to the device.
//   err: Any error encountered.
// Example:
//   device, refCount, err := GetDeviceNameFromMount("/mnt/foo")
//
// -- Doc autogenerated on 2022-05-12 14:36:06.472497 --
...
// listProcMounts returns a list of all current mounts on the system.
// Parameters:
//   mountFilePath: The path to the file to read (/proc/mounts)
// Returns:
//   A slice of MountPoint structs containing information about each mount point
//   An error if one occurred
// Example:
//   mountPoints, err := listProcMounts("/proc/mounts")
//
// -- Doc autogenerated on 2022-05-12 14:36:06.472497 --
...
// parseProcMounts parses the content of /proc/mounts and returns a slice of MountPoint structs
// See 'man proc' for more details on the file format
// It returns an error if the file content does not have the expected format
// Parameters:
//   content: the content of the /proc/mounts file
// Returns:
//   a slice of MountPoint structs, or an error if the file content does not have the expected format
// Example:
//   content, err := ioutil.ReadFile("/proc/mounts")
//   if err != nil {
//       return err
//   }
//   mounts, err := parseProcMounts(content)
//   if err != nil {
//       return err
//   }
//   for _, mount := range mounts {
//       fmt.Printf("%s %s %s %v %d %d\n", mount.Device, mount.Path, mount.Type, mount.Opts, mount.Freq, mount.Pass)
//   }
//
// -- Doc autogenerated on 2022-05-12 14:36:06.472497 --

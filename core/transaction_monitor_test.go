...
//
// -- Doc autogenerated on 2022-05-12 18:37:26.431118 --
...
// It checks that the transaction is created, then updates the transaction and checks that the
// update is persisted.
//
// -- Doc autogenerated on 2022-05-12 18:37:26.431118 --
func TestUpdateVolumeCreatingTransaction(t *testing.T) {
...
// TestVolumeCreatingTwoTransactions tests that the orchestrator can handle two volume creating transactions.
// This is a regression test for BUG-724
// It checks that the orchestrator can handle two volume creating transactions.
// It also checks that the orchestrator can handle a volume creating transaction and a clone transaction.
//
// -- Doc autogenerated on 2022-05-12 18:37:26.431118 --
func TestVolumeCreatingTwoTransactions(t *testing.T) {
	o, storeClient := setupOrchestratorAndBackend(t)
...
// and returns them.
// It returns the orchestrator and the backend.
// It also returns the backend name and the storage class name.
// Parameters:
//   t: the test object
//   backendName: the name of the backend to create
//   storageClassName: the name of the storage class to create
//   provisioningType: the provisioning
// Returns:
//   o: the orchestrator
//   storeClient: the persistent store client
//   backendName: the name of the backend
//   storageClassName: the name of the storage class
// Example:
//   o, _, _, _ := setupOrchestratorAndBackend(t, "fakeOne", "slow", "thin")
//
// -- Doc autogenerated on 2022-05-12 18:37:26.431118 --
...
// restartTransactionMonitor is a helper function to restart the transaction monitor
// with testable limits.
// Parameters:
//   o - TridentOrchestrator instance
// Returns:
//   None
// Example:

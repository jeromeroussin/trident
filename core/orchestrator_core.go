...
// recordTransactionTiming records the time taken for a transaction to complete
// to a prometheus summary.
// Parameters:
...
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
// transformPersistentState transforms the persistent state from the previous version to the current version.
...
// It returns an error if the orchestrator cannot be bootstrapped
// Returns:
//   error: error if the orchestrator cannot be bootstrapped
// Example:
//   err := orc.Bootstrap()
//   if err != nil {
//       log.Error("Failed to bootstrap orchestrator: %v", err)
//   }
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
// bootstrapBackends is called during startup to load all backends from the persistent store.
// It returns an error if any of the backends fail to initialize.
// Parameters:
...
// bootstrapStorageClasses loads the storage classes from the backend store.
// It returns an error if the storage classes cannot be loaded.
// Parameters:
//    ctx - context for logging
// Returns:
//    error - error if the storage classes cannot be loaded
// Example:
...
// bootstrapVolumes reads the volumes from the store and adds them to the orchestrator.
// It returns an error if the store is not available.
// Parameters:
//   ctx - context for logging
// Returns:
...
//   ctx - context
// Returns:
//   error - error if the store is unavailable
// Example:
...
// bootstrapVolTxns handles any volume transactions that were in progress when the orchestrator was last stopped.
// It returns an error if any of the transactions could not be handled.
// Parameters:
//   ctx - context
// Returns:
...
// bootstrapNodes is called during startup to load any existing nodes from the backend
...
// bootstrapVolumePublications bootstraps the orchestrator with existing volume publications
// It returns an error if it fails to read the volume publications from the store
// Parameters:
//   ctx - context for logging
// Returns:
//   error - if the volume publications cannot be read from the store
// Example:
//   err := bootstrapVolumePublications(ctx)
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
// addVolumePublicationToCache adds the volume publication to the cache
// Parameters:
...
// bootstrap loads the state of the orchestrator from persistent storage.
// It is called once at startup.
// It returns an error if the bootstrap fails.
// Parameters:
//     ctx - context for the operation
// Returns:
//     error - if the bootstrap fails
// Example:
//     err := o.bootstrap(ctx)
//     if err != nil {
...
//
// The transaction log is a record of operations that have been performed on
// the backend, but have not yet been persisted to the store.  If the
// orchestrator crashes before the transaction is persisted, the transaction
// log will be used to roll back the operation.
//
// The transaction log is a record of operations that have been performed on
// the backend, but have not yet been persisted to the store.  If the
// orchestrator crashes before the transaction is persisted, the transaction
...
// Parameters:
//   ctx - context for logging
//   v - the transaction to roll back
// Returns:
...
// Parameters:
//   volume: the volume to rename
// Returns:
//   error: nil if the volume was found and renamed, or an error if the volume was not found
// Example:
//   err := o.resetImportedVolumeName(ctx, volume)
//   if err != nil {
//       return fmt.Errorf("failed to reset name for imported volume %s: %v", volume.Config.Name, err)
//   }
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
//   none
// Example:
//   orchestrator.AddFrontend(frontend.NewKubernetes())
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
//   error - error if any
// Example:
//   frontend, err := tridentOrchestrator.GetFrontend(context.Background(), "ontap-nas")
//   if err != nil {
//       // handle error
//   }
//
...
// Parameters:
//   oldBackend - the current backend
//   newBackend - the backend to be updated
// Returns:
//   error - an error if the backend update is invalid
// Example:
...
//   error - error if any
// Example:
//   backendUUID, err := getBackendUUIDByBackendName("backend1")
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
// getBackendByConfigRef returns the backend based on the configRef
// Parameters:
//   configRef string
// Returns:
//   storage.Backend
//   error
// Example:
//   backend, err := o.getBackendByConfigRef(configRef)
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
// Parameters:
//   backendUUID - the UUID of the backend to return
// Returns:
...
//   err - error object
// Example:
//   backendExternal, err := o.GetBackend(ctx, backendName)
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
// Returns:
//   *storage.BackendExternal - the backend object
//   error - any error encountered
// Example:
//   backendExternal, err := orchestrator.GetBackendByBackendUUID(ctx, "backend-uuid")
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
// ListBackends returns the list of backends known to the orchestrator.
// Parameters:
//   ctx - context for the request
// Returns:
//   backends - list of backends known to the orchestrator
...
// Example:
//    err := orchestrator.DeleteBackend("myBackend")
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
// Returns:
//   error: nil if successful, otherwise reason for failure
// Example:
//   err := orchestrator.DeleteBackendByBackendUUID(ctx, "myBackend", "12345678-1234-1234-1234-1234567890ab")
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
// Example:
//   err := o.deleteBackendByBackendUUID(ctx, "my-backend", "12345678-1234-1234-1234-123456789012")
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
// It returns the external volume object and an error if any
// Parameters:
//   volumeConfig - configuration for the new volume
//   backendUUID - UUID of the backend to create the volume on
// Returns:
//   externalVol - external volume object
//   err - error if any
// Example:
//   externalVol, err := orchestrator.AddVolume(ctx, volumeConfig, backendUUID)
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
// It returns the volume object and an error
// Parameters:
//   ctx - context for logging
...
//   error - error, if any
// Example:
//   volume, err := o.CloneVolume(ctx, volumeConfig)
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
// cloneVolumeInitial clones a volume
// It returns the volume and an error if one occurred
// Parameters:
//   ctx - context
//   volumeConfig - volume config
// Returns:
...
//   error - error
// Example:
//   volume, err := orchestrator.cloneVolumeInitial(ctx, volumeConfig)
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
// cloneVolumeRetry attempts to create a clone of the specified volume on the specified backend.
// If successful, it returns the volume and backend.  If not, it returns an error.
// It returns the volume and backend even if an error is returned.
// Parameters:
//    ctx - context
//    txn - the volume transaction
// Returns:
//    externalVol - the volume
...
// Returns:
//   error: error if the volume is not valid
// Example:
...
// It returns a VolumeExternal object.
// Parameters:
//   volumeConfig: VolumeConfig object
//   backendName: Name of the backend
//   notManaged: If true, the volume is not managed by Trident
//   createPVandPVC: Callback function to create PV and PVC for the volume
// Returns:
//   VolumeExternal object
//   error
// Example:
//   importVol, err := orchestrator.LegacyImportVolume(volumeConfig, backendName, notManaged, createPVandPVC)
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
// ImportVolume imports a volume into Trident.
// It returns the volume's external representation.
// Parameters:
//   volumeConfig - the volume's configuration
//   backendUUID - the UUID of the backend where the volume is located
...
//       Size: "1GiB",
//   }
//   externalVol, err := orchestrator.ImportVolume(ctx, volumeConfig, "backend1", "testvol")
//   if err != nil {
//       log.Fatal("Failed to
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
// GetVolumeCreatingTransaction returns a VolumeTransaction with the specified
// VolumeConfig if one exists.
// Parameters:
//    ctx - context
...
//    error - error
// Example:
//    txn, err := GetVolumeCreatingTransaction(ctx, config)
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
// GetVolumeTransaction retrieves a volume transaction from the persistent store
// It returns a volume transaction and an error if one occurred
// Parameters:
//   ctx - context for the request
//   volTxn - the volume transaction to retrieve
// Returns:
//   *storage.VolumeTransaction - the retrieved volume transaction
//   error - an error if one occurred
// Example:
//   volTxn, err := o.GetVolumeTransaction(ctx, &storage.VolumeTransaction{
...
// importVolumeCleanup is called when an
// It returns an error if it was unable to clean up the volume.
// Parameters:
//   err: the error that caused the cleanup to be called
//   volumeConfig: the volume config for the volume being imported
//   volTxn: the volume transaction for the volume being imported
// Returns:
...
// Returns:
//    *storage.VolumeExternal - the volume object
//    error - any error encountered
// Example:
//    volume, err := orchestrator.GetVolume("volume-123")
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
//   error - error, if any
// Example:
//   vol, err := trident.getVolume(ctx, "vol1")
//   if err != nil {
//      // handle error
//   }
//
...
//   err - error object
// Example:
//   volumes, err := orchestrator.ListVolumes(context, options)
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
// ListVolumesByPlugin returns all volumes managed by the specified plugin.
// Parameters:
//    pluginName - name of the plugin
// Return:
//    volumes - list of volumes managed by the plugin
//    err - error if any
// Example:
//    List of volumes managed by the ontap-nas plugin
//    volumes, err := orchestrator.ListVolumesByPlugin(context.Background(), "ontap-nas")
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
//   publishInfo - the information about the node to publish to
// Return:
//   error - nil if successful
// Example:
//   err := orchestrator.PublishVolume("volume1", &utils.VolumePublishInfo{NodeID: "node1"})
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
// Parameters:
//   volumeName - the name of the volume to be unpublished
//   nodeName - the name of the node from which to unpublish the volume
// Returns:
//   error - any error encountered
// Example:
//   err := c.UnpublishVolume("vol0", "node0")
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
// Returns:
//   snapshotExternal - snapshot object
//   err - error object
// Example:
//   snapshotExternal, err := orchestrator.GetSnapshot(ctx, "volume1", "snapshot1")
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
// Parameters:
//   volumeName - name of the volume the snapshot is associated with
//   snapshotName - name of the snapshot to retrieve
// Returns:
//   *storage.SnapshotExternal - the snapshot with the given name
//   error - any error encountered
// Example:
...
// updateSnapshot updates the snapshot state from the backend
// It returns the updated snapshot and an error
// Parameters:
//   ctx - context
...
// ignoring errors if the snapshot is not found.
// It returns an error if the snapshot is found but cannot be deleted.
// Parameters:
//   ctx - context
//   snapshot - snapshot to be deleted
// Returns:
//   error - error if the snapshot is found but cannot be deleted
// Example:
...
//   filter - a filter to apply to the list of snapshots
// Returns:
//   a list of snapshots
//   an error if the operation fails
// Example:
//   snapshots, err := c.ListSnapshots(context.Background(), nil)
//   if err != nil {
//       return err
//   }
...
// ListSnapshotsByName returns a list of snapshots that match the given name.
// Parameters:
//   snapshotName - the name of the snapshot to match
//   volumeID - the ID of the volume to match
//   volumeName - the name of the volume to match
//   volume - the volume to match
//   all - if true, return all snapshots, otherwise only return snapshots that are not deleted
// Returns:
//   a list of snapshots that match the given name
//   an error, if any
// Example:
//   snapshots, err := orchestrator.ListSnapshotsByName(context.Background(), "mysnapshot")
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
// Returns:
//    ([]*storage.SnapshotExternal, error) - a list of snapshots and an error if one occurred
// Example:
//    snapshots, err := orchestrator.ListSnapshotsForVolume("vol1")
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
// ReadSnapshotsForVolume reads all snapshots for a given volume
// It returns a list of SnapshotExternal objects
// Parameters:
//   volumeName: the name of the volume
// Returns:
//   a list of SnapshotExternal objects
//   an error, if any
// Example:
//   snapshots, err := orchestrator.ReadSnapshotsForVolume("vol1")
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
// ReloadVolumes reloads all volumes from the backend
// It returns an error if the reload fails
// Parameters:
//   ctx - context
// Returns:
//   error - error if the reload fails
// Example:
...
// It returns the storage class that was added
// Parameters:
//   ctx - context for logging
//   scConfig - storage class configuration
// Returns:
//   *storageclass.External - storage class that was added
//   error - error if any
// Example:
...
// Returns:
//   *storageclass.External - the storage class with the given name
//   error - nil if no error occurred
// Example:
//   storageclass, err := o.GetStorageClass("my-storage-class")
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
//   error - any error encountered
// Example:
//   storageClasses, err := o.ListStorageClasses(context.Background())
//   if err != nil {
//       return err
//   }
//
...
//   ctx - context for the request
// Returns:
//   error - if the storage class is not found
// Example:
//   err := orchestrator.DeleteStorageClass(ctx, "mystorageclass")
//   if err != nil {
//       // handle error
//   }
//
...
// It returns an error if any of the backends fail to reconcile.
// Parameters:
//    ctx - context
// Returns:
//    error - if any of the backends fail to reconcile
// Example:
//    ctx := context.Background()
//    err := o.reconcileNodeAccessOnAllBackends(ctx)
//    if err != nil {
...
// reconcileNodeAccessOnBackend reconciles the node access on the backend
// It returns an error if the operation fails
// Parameters:
//   ctx - context
//   b - backend
...
//   nodeEventCallback - callback function to invoke when a node event occurs
// Returns:
//   error - any error encountered
// Example:
...
// handleUpdatedNodePrep handles the node prep status for a node that has been updated.
// Parameters:
//   ctx - context for logging
//   protocol - the protocol for which node prep is being reported
//   node - the node object
//   nodeEventCallback - a callback function to be called to report an event
// Returns:
//   none
// Example:
//   o.handleUpdatedNodePrep(ctx, "NFS", node, nodeEventCallback)
...
// ListNodes returns a list of all nodes known to the orchestrator.
// Parameters:
//    ctx - context for the request
// Returns:
...
//   error - any error encountered
// Example:
//   err := orchestrator.DeleteNode("mynode")
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
// It returns an error if the node is not found, or if the node is in use
// Parameters:
//   ctx - context for the request
//   nodeName - name of the node to delete
// Return:
//   error - if the node is not found, or if the node is in use
// Example:
...
// listVolumePublicationsForVolume returns the list of volume publications for a given volume
// Parameters:
//   volumeName - name of the volume
// Returns:
//   list of volume publications for the given volume
// Example:
//   publications := o.listVolumePublicationsForVolume(ctx, "foo")
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
func (o *TridentOrchestrator) listVolumePublicationsForVolume(
	_ context.Context, volumeName string,
...
// listVolumePublicationsForNode returns the list of volume publications for the given node
// Parameters:
//   nodeName - the name of the node
// Returns:
//   []*utils.VolumePublication - the list of volume publications for the node
// Example:
//   publications := o.listVolumePublicationsForNode(nodeName)
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
func (o *TridentOrchestrator) listVolumePublicationsForNode(
...
//   None
// Example:
//   removeVolumePublicationFromCache(volumeID, nodeID)
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
//   newBackend - true if this is a new backend
// Returns:
...
// It returns an error if the volume cannot be updated.
// Parameters:
//   ctx - context for logging
//   vol - volume to be updated
// Returns:
//   error - error if the volume cannot be updated
// Example:
//   err := orchestrator.updateVolumeOnPersistentStore(ctx, vol)
//   if err != nil {
//       log.Errorf("Could not update volume %s on persistent store: %v",
//           vol.Config.Name, err)
//   }
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
// It returns an error if the backend or volume information cannot be updated.
// Parameters:
//   origBackend - the original backend
//   newBackend - the new backend
// Returns:
//   error - if the backend or volume information cannot be updated
// Example:
//   err := o.replaceBackendAndUpdateVolumesOnPersistentStore(ctx, origBackend, newBackend)
//   if err != nil {
//       Logc(ctx).Errorf("Error updating backend %s and volumes: %v", newBackend.Name(), err)
//   }
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
// CanBackendMirror returns true if the backend is capable of mirroring
// Parameters:
//   backendUUID - the backend UUID
// Returns:
//   capable - true if the backend is capable of mirroring
//   err - any error encountered
// Example:
//   capable, err := tridentcore.CanBackendMirror(backendUUID)
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --
...
// GetCHAP returns CHAP information for a volume
// Parameters:
//   volumeName - Name of the volume
...
//   err - error object
// Example:
//   chapInfo, err := orchestrator.GetCHAP(ctx, "vol1", "node1")
//
// -- Doc autogenerated on 2022-05-12 19:51:03.426932 --

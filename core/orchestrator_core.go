...
// to the operationDurationInMsSummary metric.
// Parameters:
//   txn: the transaction
...
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
func recordTransactionTiming(txn *storage.VolumeTransaction, err *error) {
...
// transformPersistentState transforms the persistent state to the current version.
...
// Returns:
//   - BootstrapError if the orchestrator is already bootstrapped
//   - InternalError if the orchestrator fails to bootstrap
// Example:
//   - err := orchestrator.Bootstrap()
//   - if err != nil {
//       log.Errorf("Failed to bootstrap orchestrator: %v", err)
//   }
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
...
// Returns:
//    error - error if any backends fail to initialize
// Example:
...
// bootstrapStorageClasses is called during startup to load persistent storage classes from the backend.
// It returns an error if the persistent storage classes cannot be loaded.
// Parameters:
//   ctx - context
// Returns:
//   error - error if the persistent storage classes cannot be loaded
// Example:
...
// It returns an error if the volumes cannot be retrieved from the store.
// Parameters:
//   ctx - context for logging
// Returns:
//   error - error if the volumes cannot be retrieved from the store
// Example:
...
// bootstrapSnapshots adds existing snapshots to the orchestrator's snapshot map.
// It returns an error if the snapshot cannot be added.
// Parameters:
//   ctx - context
// Returns:
//   error - error if the snapshot cannot be added
// Example:
...
// bootstrapVolTxns bootstraps volume transaction logs from persistent store
// It returns an error if it fails to bootstrap any volume transaction log
// Parameters:
//   ctx - context
// Returns:
//   error - error if any
...
// It returns an error if it fails to bootstrap
// Parameters:
//   ctx - context
// Returns:
//   error - error if it fails to bootstrap
// Example:
...
// bootstrapVolumePublications loads all existing volume publications from the backend
// and adds them to the orchestrator's cache.
// It returns an error if the backend could not be contacted.
// Parameters:
//   ctx - context for logging
// Returns:
//   error - error if the backend could not be contacted
// Example:
...
// Parameters:
//   vp - volume publication to add
// Returns:
//   none
// Example:
//   orchestrator.addVolumePublicationToCache(vp)
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
...
// bootstrap loads all persistent data from the store and initializes the
// orchestrator's internal state.
// It returns an error if the bootstrap fails.
// Parameters:
//    ctx - context for the operation
// Returns:
//    error - any error encountered during bootstrap
// Example:
//    err := o.bootstrap(ctx)
//    if err != nil {
//        // handle error
...
// It is called when a transaction is found in the persistent store that
// doesn't have a corresponding transaction object in memory.
//
// This function is called with the orchestrator lock held.
// It returns an error if it is unable to clean up the transaction.
// Parameters:
//   ctx - context for logging
//   v - the volume transaction to clean up
// Returns:
//   error - an error if the transaction could not be cleaned up
// Example:
//   err := handleFailedTransaction(ctx, v)
//   if err != nil {
//     log.Errorf("Unable to clean up transaction %v: %v", v.ID(), err)
//   }
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
func (o *TridentOrchestrator) handleFailedTransaction(ctx context.Context, v *storage.VolumeTransaction) error {
...
// resetImportedVolumeName resets the name of a volume that was imported.
// It returns an error if the volume was not found.
// Parameters:
//    ctx - context
//    volume - volume to reset
// Returns:
//    error - error if the volume was not found
// Example:
//    Reset the volume name for a volume that was imported
...
// GetFrontend returns the frontend plugin for the specified name
// Parameters:
//   ctx - context for logging
...
// Example:
//   frontend, err := o.GetFrontend(ctx, "nfs")
//   if err != nil {
//       // handle error
//   }
//
...
// Returns:
//   error - an error if the update is not allowed
// Example:
...
//     log.Error(err)
//   } else {
//     log.Infof("Orchestrator version is %s", version)
//   }
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
...
// getBackendUUIDByBackendName returns the UUID of a backend given its name
// Parameters:
...
// Returns:
//   storage.Backend - the backend with the specified configRef
//   error - nil if the backend was found, or an error if the backend was not found
// Example:
//   backend, err := getBackendByConfigRef("backend1")
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
...
// Parameters:
//   backendUUID - the UUID of the backend to retrieve
// Returns:
//   storage.Backend - the backend with the specified UUID
//   error - nil if no error occurred
// Example:
//   backend, err := orchestrator.getBackendByBackendUUID("be-12345678-1234-1234-1234-123456789012")
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
...
// GetBackendByBackendUUID returns the backend object for the given backend UUID
// Parameters:
//   ctx - context for logging
//   backendUUID - UUID of the backend
// Returns:
...
//   error - error object
// Example:
//   backendExternal, err := o.GetBackendByBackendUUID(ctx, backendUUID)
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
...
// Example:
//   backends, err := tridentOrchestrator.ListBackends(ctx)
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
...
//   ctx - the context for the operation
// Returns:
//   error - nil if successful, non-nil if an error occurred
// Example:
//   err := o.DeleteBackend("backend1", ctx)
//   if err != nil {
//       log.Errorf("DeleteBackend failed: %v", err)
//   }
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
...
// Parameters:
//   backendName - the name of the backend to delete
//   backendUUID - the UUID of the backend to delete
// Returns:
//   error - nil if successful
// Example:
//   err := orchestrator.DeleteBackendByBackendUUID(ctx, "backend1", "6e0c6e1e-b5d0-11e7-9598-080027d29755")
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
...
// Returns:
//   error - if the backend is not found
// Example:
//   err := o.deleteBackendByBackendUUID(ctx, "ontap-nas", "12345678-1234-1234-1234-123456789012")
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
...
// AddVolume adds a new volume to the system.
// It returns the volume's external representation.
// Parameters:
//   volumeConfig: the volume configuration
//   backendUUID: the UUID of the backend to use for this volume
//   backend: the backend to use for this volume
//   backendState: the state of the backend to use for this volume
//   backendName: the name of the backend to use for this volume
//   backendFilesystem: the filesystem of the backend to use for this volume
//   backendPool: the pool of the backend to use for this volume
//   backendInternal: whether or not the backend is internal
//   backendAccessInfo: the access info of the backend to use for this volume
//   backendBlockSizeBytes: the block size of the backend to use for this volume
//   backendStoragePrefix: the storage prefix of the backend to use for this volume
//   backendStorageClasses: the storage classes of the backend to use for this volume
// Returns:
//   externalVol: the volume's external representation
//   err: any errors encountered
// Example:
//   externalVol, err := o.AddVolume(volumeConfig)
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
func (o *TridentOrchestrator) AddVolume(
...
// It returns the volume spec and a transaction ID
// Parameters:
//   ctx - context
//   volumeConfig - the volume config
// Returns:
//   *storage.VolumeExternal - the volume spec
//   error - any error encountered
// Example:
//   volumeSpec, err := orchestrator.CloneVolume(ctx, volumeConfig)
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
func (o *TridentOrchestrator) CloneVolume(
	ctx context.Context, volumeConfig *storage.VolumeConfig,
...
// It returns the new volume and a transaction ID that can be used to roll back
// the operation.
// Parameters:
//   ctx - the context for the operation
...
// Example:
//   externalVol, txnID, err := orch.cloneVolumeInitial(ctx, volumeConfig)
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
...
// cloneVolumeRetry is called to retry a volume clone operation.
...
// LegacyImportVolume imports a volume that was created outside of Trident.
// It returns an error if the volume already exists.
// Parameters:
//   volumeConfig: the configuration for the volume to be imported
//   backendName: the name of the backend on which the volume will be imported
//   notManaged: if true, the volume will not be managed by Trident
//   createPVandPVC: a callback function that creates a PV and PVC for the imported volume
// Returns:
//   externalVol: the volume that was imported
//   err: any error encountered
// Example:
//   externalVol, err := o.LegacyImportVolume(ctx, volumeConfig, backendName, notManaged, createPVandPVC)
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
...
// GetVolumeCreatingTransaction returns the volume transaction for a volume that is being created.
// Parameters:
//   ctx - context for the operation
...
//   error - error, if any
// Example:
//   volTxn, err := o.GetVolumeCreatingTransaction(ctx, config)
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
func (o *TridentOrchestrator) GetVolumeCreatingTransaction(
...
// It returns an error if the transaction does not exist
// Parameters:
...
//   error - error if any
// Example:
//   volTxn, err := orchestrator.GetVolumeTransaction(ctx, &storage.VolumeTransaction{
...
// importVolumeCleanup is called when an error is encountered during the
// It returns an error if it is unable to clean up the volume.
// Parameters:
//   err: error encountered during import
//   volumeConfig: volume config of the volume being imported
//   volTxn: volume transaction of the volume being imported
// Returns:
//   error: error encountered during cleanup
// Example:
//   err := importVolumeCleanup(ctx, err, volConfig, volTxn)
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
func (o *TridentOrchestrator) importVolumeCleanup(
...
// Parameters:
//    volume - name of the volume to return
// Returns:
//    *storage.VolumeExternal - volume object
//    error - error, if any
// Example:
//    vol, err := tridentOrchestrator.GetVolume(context.Background(), "myvol")
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
...
//    error - error object
// Example:
//    volume, err := tridentOrchestrator.getVolume("volume1")
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
func (o *TridentOrchestrator) getVolume(
...
// Parameters:
//     vol *storage.VolumeExternal - volume to query
// Returns:
//     string - driver type
//     error - any error
// Example:
//     type, err := o.GetDriverTypeForVolume(vol)
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
...
//    error
// Example:
//    volumeType, err := orchestrator.GetVolumeType(vol)
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
func (o *TridentOrchestrator) GetVolumeType(
...
// errors if the volume is not found.
// It returns an error if the volume is found but cannot be deleted.
// Parameters:
//   ctx - context
//   volume - volume to delete
// Returns:
//   error - error if the volume is found but cannot be deleted
// Example:
...
// ListVolumesByPlugin returns a list of volumes for the specified plugin.
// Parameters:
//    pluginName - the name of the plugin
// Returns:
//    []*storage.VolumeExternal - a list of volumes
//    error - any error encountered
// Example:
//    volumes, err := c.ListVolumesByPlugin("ontap-nas")
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
func (o *TridentOrchestrator) ListVolumesByPlugin(
...
// PublishVolume publishes a volume to a set of nodes
...
// Example:
//   err := orchestrator.PublishVolume(ctx, volumeName, publishInfo)
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
...
//   error - any error encountered
// Example:
//   err := orchestrator.UnpublishVolume(context.Background(), "vol1", "node1")
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
...
// GetSnapshot retrieves the snapshot object for a given volume and snapshot name.
// It returns a SnapshotExternal object.
// Parameters:
//   ctx - context for logging
//   volumeName - name of the volume
...
// Example:
//   snapshot, err := tridentOrchestrator.GetSnapshot(ctx, "foo", "snapshot1")
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
func (o *TridentOrchestrator) GetSnapshot(
...
// getSnapshot retrieves a snapshot from the orchestrator's cache.
// It returns a NotFoundError if the snapshot is not found.
// If the snapshot is in the process of being created or uploaded,
// it will attempt to update the snapshot's state from Trident.
// Parameters:
//   volumeName - the name of the volume the snapshot belongs to
//   snapshotName - the name of the snapshot
// Returns:
//   *storage.SnapshotExternal - the snapshot object
//   error - any error encountered
// Example:
//   snapshot, err := o.getSnapshot(ctx, "my-volume", "my-snapshot")
//   if err != nil {
//       // handle error
//   }
//
...
// updateSnapshot updates the snapshot's state in the orchestrator and persistent store
// It returns the updated snapshot and any error encountered
// Parameters:
//   ctx - context
...
// deleteSnapshotFromPersistentStoreIgnoreError deletes a snapshot from the persistent store, ignoring
// errors if the snapshot is not found.
// It returns an error if the snapshot is found but cannot be deleted.
// Parameters:
...
//   if err != nil {
//       return fmt.Errorf("error deleting snapshot %v: %v", snapshot.Config.Name, err)
//   }
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
func (o *TridentOrchestrator) deleteSnapshotFromPersistentStoreIgnoreError(
...
//    error - error if any
// Example:
//    snapshotList, err := orchestrator.ListSnapshots(context.Background())
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
func (o *TridentOrchestrator) ListSnapshots(context.Context) (snapshots []*storage.SnapshotExternal, err error) {
	if o.bootstrapError != nil {
...
// ListSnapshotsByName lists all snapshots with the given name
// It returns a list of SnapshotExternal objects
// Parameters:
//   snapshotName - the name of the snapshot to list
// Returns:
//   []*storage.SnapshotExternal - a list of SnapshotExternal objects
//   error - any error encountered
// Example:
//   snapshots, err := orchestrator.ListSnapshotsByName("mySnapshot")
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
...
// ListSnapshotsForVolume returns a list of snapshots for a given volume
// Parameters:
//    ctx - context for logging
//    volumeName - name of the volume
// Returns:
//    list of snapshots for the given volume
//    error - non-nil if an error occurred
// Example:
...
//    error - any error encountered
// Example:
//    snapshots, err := orchestrator.ReadSnapshotsForVolume(ctx, volumeName)
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
...
// ReloadVolumes re-reads the list of volumes from the backend and updates the
// orchestrator's internal state.
// It returns an error if the volume list could not be retrieved.
// Parameters:
//    ctx - context for logging
// Returns:
...
// It returns the storage class and an error if one occurred
// Parameters:
//   ctx - context for logging
//   scConfig - storage class configuration
// Returns:
//   *storageclass.External - storage class
//   error - error if one occurred
// Example:
...
//   error - any error encountered
// Example:
//   sc, err := tridentOrchestrator.GetStorageClass(ctx, "sc1")
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
...
//   error - any error encountered
// Example:
//   err := orchestrator.DeleteStorageClass(ctx, "my-storage-class")
//   if err != nil {
//       log.Error("Error deleting storage class: ", err)
//   }
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
...
// It returns an error if the node could not be added
// Parameters:
//   ctx - context
//   node - the node to add
//   nodeEventCallback - callback function to be invoked when a node event occurs
// Return:
//   error - error if the node could not be added
// Example:
...
// invalidateAllBackendNodeAccess invalidates the node access cache for all backends.
// Returns:
//   - nil if successful
...
// handleUpdatedNodePrep handles node prep updates from the backend
// Parameters:
//   ctx - context
//   protocol - protocol for which node prep is being reported
//   node - node for which node prep is being reported
//   nodeEventCallback - callback to invoke to report node events
// Returns:
//   none
// Example:
...
// GetNode returns the node object for the specified node name
// Parameters:
//   ctx - context for logging
//   nName - name of the node
// Returns:
//   *utils.Node - the node object
//   error - error if any
// Example:
//   node, err := GetNode(context.TODO(), "localhost")
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
...
// Parameters:
//   context - context for the request
//   filter - filter to apply to the list
// Returns:
//   []*utils.Node - list of nodes
//   error - error if any
// Example:
//   nodes, err := core.ListNodes(context, nil)
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
...
// Returns:
//   error - error if the node could not be deleted
// Example:
//   error := orchestrator.DeleteNode(ctx, "node1")
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
...
//   nodeName - name of the node to delete
// Returns:
//   error - error if the node is not found
// Example:
...
func (o *TridentOrchestrator) listVolumePublicationsForVolume(
// listVolumePublicationsForVolume returns a list of publications for the given volume
// Parameters:
//    volumeName - name of the volume
// Returns:
//    list of publications for the given volume
// Example:
...
func (o *TridentOrchestrator) listVolumePublicationsForNode(
// listVolumePublicationsForNode returns the list of published volumes for a given node
// Parameters:
//   nodeName - the name of the node
// Returns:
//   []*utils.VolumePublication - the list of published volumes for the node
// Example:
//   volumes, err := o.listVolumePublicationsForNode(ctx, "kube-node-1")
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
func (o *TridentOrchestrator) listVolumePublicationsForNode(
...
// Example:
//   err := updateBackendOnPersistentStore(ctx, backend, true)
//   if err != nil {
//     return err
//   }
//
...
// Returns:
//   error - an error if the backend or volume information could not be updated
// Example:
//   error := o.replaceBackendAndUpdateVolumesOnPersistentStore(ctx, oldBackend, newBackend)
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
...
// CanBackendMirror checks if the backend can mirror
// It returns true if the backend can mirror and false otherwise
// Parameters:
//    backendUUID - the backend UUID
// Returns:
//    capable - true if the backend can mirror, false otherwise
//    err - any error encountered
// Example:
//    capable, err := o.CanBackendMirror(ctx, backendUUID)
//
// -- Doc autogenerated on 2022-05-12 17:31:11.257272 --
func (o *TridentOrchestrator) CanBackendMirror(_ context.Context, backendUUID string) (capable bool, err error) {

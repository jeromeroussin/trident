...
//   err - the error if there is any
// Returns:
//   error - the error if the update is invalid, nil if the update is valid
// Example:
//   err := o.recordTiming("backend_add", err)
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 10725abd4157c24fed404e7638b0fc0c --
...
// recordTransactionTiming records the timing of a volume transaction.
// Parameters:
//   txn - the volume transaction
//   err - the error if there is any
// Example:
//   recordTransactionTiming(txn, err)
//
// -- Doc autogenerated on 2022-06-21. Function hash: d39f7d63300a6cea90e7402ac7280126 --
...
// It returns a new storage orchestrator instance
// Parameters:
//   client - the persistent store client
// Returns:
//   *TridentOrchestrator - the new storage orchestrator instance
// Example:
//   orchestrator := NewTridentOrchestrator(client)
//
// -- Doc autogenerated on 2022-06-21. Function hash: 191889dd8a79b6ce0f352ad6106b0f84 --
...
// transformPersistentState transforms the persistent store to the current Trident API version.
// It returns an error if the transformation fails.
// Parameters:
//   ctx - context for logging
// Returns:
//   error - the error if the transformation fails, nil if the transformation succeeds
// Example:
//   err := o.transformPersistentState(ctx)
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: c9019c1c63e1407926e156160bcba2b4 --
...
// Bootstrap initializes the orchestrator.  It reads persistent state from the
// database and initializes the in-memory state.  It also initializes the
...
//   err := o.Bootstrap(ctx)
//
// -- Doc autogenerated on 2022-06-21. Function hash: 04dcb5d2d9ba6669a7ec6f5734590b4e --
...
// bootstrapBackends initializes the backends that were persisted in the store.
...
//   error - the error if there is any
// Example:
//   err := o.bootstrapBackends(ctx)
//
// -- Doc autogenerated on 2022-06-21. Function hash: ace19e963152e034bd3e2ad4e44efd2a --
...
// bootstrapStorageClasses initializes the storage class cache from the backend store.
// It returns an error if the initialization fails.
// Parameters:
//   ctx - context for logging
// Returns:
...
//
// -- Doc autogenerated on 2022-06-21. Function hash: 21a98ba2c9aed0a70ca745011194074a --
...
// bootstrapVolumes updates the o.volumes cache with the latest backend data. This function should only edit o.volumes in place to avoid
...
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 713a6e9aafc3998ba2508038c533087d --
...
// bootstrapSnapshots initializes the snapshots map with snapshots that already exist in the backend.
// It returns an error if the initialization fails.
// Parameters:
//   ctx - context for logging
// Returns:
//   error - the error if the initialization is invalid, nil if the initialization is valid
// Example:
//   err := o.bootstrapSnapshots(ctx)
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 7cc86ef066af5a6d4d4cccf2aaacc362 --
...
// bootstrapVolTxns initializes the volume transaction logs from the persistent store.
// It returns an error if the initialization fails.
// Parameters:
//   ctx - context for logging
// Returns:
...
//
// -- Doc autogenerated on 2022-06-21. Function hash: e33c0ea45aaa4a9d8262fd4f04ac4667 --
...
// bootstrapNodes initializes the nodes in the store.
// It returns an error if the initialization fails.
// Parameters:
//   ctx - context for logging
// Returns:
...
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 7cfe94c5ecbb68533b741378eaa5ee46 --
...
// bootstrapVolumePublications initializes the volume publications cache with any publications that already exist in the store.
// It returns an error if the initialization fails.
// Parameters:
//   ctx - context for logging
// Returns:
...
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: feea1b84b5d4a911d16860d0c211b775 --
...
// addVolumePublicationToCache adds a volume publication to the cache.
// Parameters:
//   vp - the volume publication
// Example:
//   o.addVolumePublicationToCache(vp)
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 6831b1fc734710c782e9132682016e51 --
...
// bootstrap initializes the orchestrator by fetching all of the backends, storage classes, volumes, snapshots,
// volumetxns, nodes, and volume publications from the store.  It also initializes the core metrics.
// It returns an error if any of the fetches fail.
// Parameters:
//   ctx - context for logging
// Returns:
//   error - error if there is any
...
//   err := o.bootstrap(ctx)
//
// -- Doc autogenerated on 2022-06-21. Function hash: bcd99e963177e37d4f93a0ee26ad9890 --
...
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 3a67a0fe542b11aed94153d8aabdd3cc --
...
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: ab104a423eb8f8557aa63ebaff87a6bf --
...
// handleFailedTransaction handles the failed transaction.
// It returns an error if the transaction is invalid.
// Parameters:
//   ctx - context for logging
//   v - the volume transaction
// Returns:
//   error - the error if there is any
// Example:
//   err := o.handleFailedTransaction(ctx, v)
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 39541d951f05903909338f9e59963947 --
...
// resetImportedVolumeName resets the name of an imported volume to its original name.
// It returns an error if the volume cannot be renamed.
// Parameters:
//   ctx - context for logging
//   volume - the volume to reset
// Returns:
//   error - the error if the reset failed, nil if the reset succeeded
// Example:
//   err := o.resetImportedVolumeName(ctx, volume)
//
// -- Doc autogenerated on 2022-06-21. Function hash: 1033950f7f2014fd8a87dbfb93781f51 --
...
// AddFrontend adds a new frontend to the orchestrator.
// Parameters:
//   f - the frontend plugin
// Example:
//   orchestrator.AddFrontend(frontend1)
//
// -- Doc autogenerated on 2022-06-21. Function hash: be80e16a539796ac4231803c9351df2d --
...
// GetFrontend returns a frontend by name
// It returns an error if the frontend does not exist
// Parameters:
//   ctx - context for logging
//   name - the name of the frontend
// Returns:
//   frontend.Plugin - the frontend
//   error - error if there is any
// Example:
//   fe, err := orchestrator.GetFrontend(ctx, "frontend1")
//
// -- Doc autogenerated on 2022-06-21. Function hash: 68c5aa2cdd27528e7d82eb37fe73b601 --
...
//
// -- Doc autogenerated on 2022-06-21. Function hash: 80555ddd7f23803234d84705cd8e72e3 --
...
// It returns an error if the orchestrator is not yet initialized.
// Parameters:
//   ctx - context for logging
// Returns:
//   string - the version of the orchestrator
//   error - the error if there is any
// Example:
//   version, err := o.GetVersion(ctx)
//
// -- Doc autogenerated on 2022-06-21. Function hash: b3ff28ff24fcdaca9fca3da6aa509290 --
...
// It returns an error if the backend cannot be added.
// Parameters:
//   ctx - context for logging
//   configJSON - the JSON configuration for the backend
//   configRef - the reference to the backend configuration
// Returns:
//   storage.BackendExternal - the backend external representation
//   error - the error if the backend cannot be added, nil if the backend is added successfully
// Example:
//   backendExternal, err := o.AddBackend(ctx, configJSON, configRef)
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 34be8d97dce7cb93c1f08707afc3fa62 --
...
//   configRef - the configRef for the backend
// Returns:
//   storage.BackendExternal - the backend external representation
//   error - the error if the backend cannot be added, nil if the backend is added
// Example:
//   backendExternal, err := o.addBackend(ctx, configJSON, backendUUID, configRef)
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 1844d31bca8826ed9ced9036eb98c934 --
func (o *TridentOrchestrator) addBackend(
...
//   error - the error if the update is invalid, nil if the update is valid
// Example:
//   err := o.validateAndCreateBackendFromConfig(ctx, configJSON, configRef, backendUUID)
//
// -- Doc autogenerated on 2022-06-21. Function hash: 2fefe24643f68e5970070168da26f2d9 --
...
//   error - the error if the update is invalid, nil if the update is valid
// Example:
//   backend, err := o.UpdateBackend(ctx, "backend1", configJSON, configRef)
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: ac16cef94ad15602c48bdc8ddaac8f09 --
...
//   ctx - context for logging
//   backendName - the name of the backend
//   configJSON - JSON string representation of the backend config
//   configRef - configuration reference for this orchestrator (e.g. a configmap)
// Returns:
//   storage.BackendExternal - the backend external
//   error - the error if the update is invalid, nil if the update is valid
// Example:
//   backendExternal, err := orchestrator.updateBackend("backend1", "configJSON", "backendUUID", "configRef")
//
// -- Doc autogenerated on 2022-06-21. Function hash: 77a2adc15ab73dcb06f28116870daedc --
func (o *TridentOrchestrator) updateBackend(
	ctx context.Context, backendName, configJSON, configRef string,
) (backendExternal *storage.BackendExternal, err error) {
...
//   configJSON - the JSON configuration for the backend
//   backendUUID - the UUID of the backend
//   configRef - the config reference for the backend
// Returns:
//   storage.BackendExternal - the backend
//   error - the error if the update is invalid, nil if the update is valid
// Example:
//   backend, err := orchestrator.UpdateBackendByBackendUUID(ctx, "backend1", configJSON, backendUUID, configRef)
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 44aa8fb20d8dabe1ff9780954d172644 --
...
//   configJSON - the JSON configuration for the backend
//   backendUUID - the UUID of the backend
//   callingConfigRef - the UUID of the TridentBackendConfig CR that initiated this update
// Returns:
//   storage.BackendExternal - the backend external representation
//   error - error if there is any
// Example:
//   backendExternal, err := orchestrator.updateBackendByBackendUUID(ctx, "backend1", configJSON, "uuid1", "uuid2")
//
// -- Doc autogenerated on 2022-06-21. Function hash: 8026625a6962d3055aaee3801d241d07 --
func (o *TridentOrchestrator) updateBackendByBackendUUID(
...
//   ctx - context for logging
//   backendName - the name of the backend
//   backendState - the new state of the backend
// Returns:
//   storage.BackendExternal - the backend
//   error - error if there is any
// Example:
//   backend, err := orchestrator.UpdateBackendState(ctx, "backend1", "up")
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 98c9ddbad561e4fd433f44fac8ab4e78 --
...
//   error - the error if the update is invalid, nil if the update is valid
// Example:
//   backend, err := orchestrator.updateBackendState(ctx, "backend1", "Failed")
//
// -- Doc autogenerated on 2022-06-21. Function hash: 2a4b31771a2b11c73b1d43bc4fa94d33 --
func (o *TridentOrchestrator) updateBackendState(
	ctx context.Context, backendName, backendState string,
) (backendExternal *storage.BackendExternal, err error) {
	var backend storage.Backend
...
// getBackendUUIDByBackendName returns a backend UUID by name
// It returns an error if the backend UUID is not found.
// Parameters:
//   backendName - the name of the backend
// Returns:
//   string - the UUID of the backend
//   error - error if there is any
// Example:
//   backendUUID, err := orchestrator.getBackendUUIDByBackendName("backend1")
//
// -- Doc autogenerated on 2022-06-21. Function hash: 3432223f3c321828475a38387539f630 --
...
//
// -- Doc autogenerated on 2022-06-21. Function hash: 5359cbb6a4e1cb6e05469580d3214563 --
...
// getBackendByConfigRef returns a backend by configRef
// It returns an error if the backend is not found.
// Parameters:
...
//   error - error if there is any
// Example:
//   backend, err := orchestrator.getBackendByConfigRef("configRef1")
//
// -- Doc autogenerated on 2022-06-21. Function hash: 37e7727af627a51a35149814c5e420af --
...
// getBackendByBackendUUID returns a backend by UUID
// It returns an error if the backend UUID is not found.
// Parameters:
//   backendUUID - the UUID of the backend
// Returns:
...
//   error - error if there is any
// Example:
//   backend, err := orchestrator.getBackendByBackendUUID("backend1")
//
// -- Doc autogenerated on 2022-06-21. Function hash: 5b6c42a570cd7be7efb047a76057cbdd --
...
//
// -- Doc autogenerated on 2022-06-21. Function hash: 97ea7edf0258bdf4ee62e165318ef219 --
...
// GetBackendByBackendUUID returns a backend by UUID
// It returns an error if the backend UUID is invalid.
// Parameters:
//   ctx - context for logging
//   backendUUID - the UUID of the backend
// Returns:
...
//   error - error if there is any
// Example:
//   backend, err := orchestrator.GetBackendByBackendUUID(ctx, "backend1")
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 81d8fa64dc1b3803acd28fbacf4b0287 --
...
// ListBackends lists all the backends that are currently configured.
// It returns an error if there is any.
// Parameters:
//   ctx - context for logging
// Returns:
//   []*storage.BackendExternal - the list of backends
//   error - the error if there is any
// Example:
//   backendExternals, err := o.ListBackends(ctx)
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 2d98525f51bd5d6b7df26ff8693141e9 --
...
// It returns an error if the backend doesn't exist or if the backend is in use.
// Parameters:
//   ctx - context for logging
//   backendName - the name of the backend to delete
// Returns:
//   error - the error if the backend could not be deleted, nil if the backend was deleted
// Example:
//   err := o.DeleteBackend(ctx, "backend1")
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: dac0943d6e46a81a0f9787f5f6ef64f3 --
...
// DeleteBackendByBackendUUID deletes a backend by UUID.
// It returns an error if the backend doesn't exist.
// Parameters:
//   ctx - context for logging
//   backendName - the name of the backend
//   backendUUID - the UUID of the backend
// Returns:
//   error - the error if the delete failed, nil if the delete succeeded
// Example:
//   err := o.DeleteBackendByBackendUUID(ctx, "backend1", "12345")
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: ade56985c915048a2ff8350f698c0690 --
...
// deleteBackendByBackendUUID deletes a backend by name
// It returns an error if the backend doesn't exist or if the backend has volumes.
// Parameters:
//   ctx - context for logging
//   backendName - the name of the backend
//   backendUUID - the UUID of the backend
...
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 2568753d63d7e3305bdc4b1ea5d422de --
...
//   error - the error if the update is invalid, nil if the update is valid
// Example:
//   err := o.RemoveBackendConfigRef(ctx, backendUUID, configRef)
//
// -- Doc autogenerated on 2022-06-21. Function hash: 331e58f467a6cdb46f9fe1e3df756370 --
...
// It returns an error if the volume already exists or if the backend does not exist.
// Parameters:
//   ctx - context for logging
//   volumeConfig - the volume config
// Returns:
//   storage.VolumeExternal - the new volume
//   error - error if there is any
// Example:
//   externalVol, err := orchestrator.AddVolume(ctx, volumeConfig)
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 6b3abc4db9d4558bf39248381f6e73e6 --
...
// It returns an error if the volume creation is invalid.
// Parameters:
//   ctx - context for logging
//   volumeConfig - the volume config
// Returns:
//   externalVol - the external volume
//   error - the error if the creation is invalid, nil if the creation is valid
// Example:
//   externalVol, err := o.addVolumeInitial(ctx, volumeConfig)
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: b5ae8d6da66bca2cf182c5d0013b1c02 --
...
// This method should only be called from AddVolume, as it does not take locks or otherwise do much validation
// of the volume config.
// It returns an error if the volume creation operation fails.
// Parameters:
//   ctx - context for logging
//   txn - the volume transaction
// Returns:
//   externalVol - the external volume
//   error - the error if the volume creation operation fails, nil if it succeeds
// Example:
//   externalVol, err := o.addVolumeRetry(ctx, txn)
//
// -- Doc autogenerated on 2022-06-21. Function hash: 1ef65ba5121b49ef47f655224be95398 --
...
//   pool - the pool
// Returns:
//   storage.VolumeExternal - the external volume
//   error - the error if there is any
// Example:
//   externalVol, err := o.addVolumeFinish(ctx, txn, vol, backend, pool)
//
// -- Doc autogenerated on 2022-06-21. Function hash: 550c1e0b637b8b5a2f43afa834fd1758 --
...
// CloneVolume creates a new volume by cloning an existing volume.
// It returns an error if the new volume cannot be created.
// Parameters:
//   ctx - context for logging
...
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 3b05245cf8d531e1b7e704f1d7673887 --
...
//   error - error if there is any
// Example:
//   externalVol, err := orchestrator.cloneVolumeInitial(ctx, volumeConfig)
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 3f83112418a823bdafb4b150c3214f8e --
...
// cloneVolumeRetry validates that the backend update is valid.
// It returns an error if the backend update is invalid.
// Parameters:
//   ctx - context for logging
//   txn - the volume transaction
...
//   error - the error if the update is invalid, nil if the update is valid
// Example:
//   err := o.cloneVolumeRetry(ctx, txn)
//
// -- Doc autogenerated on 2022-06-21. Function hash: d3195084da6ca49594299f21956d774c --
...
// It returns an error if the volume doesn't exist.
// Parameters:
//   ctx - context for logging
//   volumeName - the name of the volume
//   backendName - the name of the backend
// Returns:
//   volExternal - the VolumeExternal representation of the volume
//   error - the error if the volume doesn't exist, nil if the volume exists
// Example:
//   volExternal, err := o.GetVolumeExternal(ctx, "volume1", "backend1")
//
// -- Doc autogenerated on 2022-06-21. Function hash: 6d7df3139b77d4e7f3b0c5a1f0401aed --
...
// It returns the volume name and error if any
// Parameters:
//   volumeInternal - the internal name of the volume
//   context - context for logging
// Returns:
//   string - the volume name
//   error - error if any
// Example:
//   volume, err := orchestrator.GetVolumeByInternalName("volume1", nil)
//
// GetVolumeExternal queries a backend driver for a given volume identified by the
// internal name.  If the volume doesn't exist, an error is returned.
//
// -- Doc autogenerated on 2022-06-21. Function hash: e81135d85cf26e9b05d143d437569df4 --
...
// validateImportVolume validates that the volume import is valid.
// It returns an error if the volume import is invalid.
// Parameters:
//   ctx - context for logging
//   volumeConfig - the volume config
// Returns:
//   error - the error if the import is invalid, nil if the import is valid
// Example:
//   err := o.validateImportVolume(ctx, volumeConfig)
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 0b239a8ef621ed2e08adbc4c80a11281 --
...
// LegacyImportVolume imports a volume from an external storage backend.
// It returns an error if the volume cannot be imported.
// Parameters:
//   ctx - context for logging
//   volumeConfig - the volume config
//   backendName - the name of the backend
//   notManaged - if true, the volume will not be persisted in the store
//   createPVandPVC - the callback function to create PV and PVC for the volume
// Returns:
//   storage.VolumeExternal - the volume external
//   error - error if there is any
// Example:
//   volExternal, err := o.LegacyImportVolume(ctx, volumeConfig, backendName, notManaged, createPVandPVC)
//
// -- Doc autogenerated on 2022-06-21. Function hash: f8c072d23374263c1a818a13bc96fac1 --
...
// ImportVolume imports a volume into Trident.  The volume must already exist on the specified backend.
// It returns an error if the volume cannot be imported.
// Parameters:
//   ctx - context for logging
//   volumeConfig - the volume config
...
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: caf9bc105080edc2f7b86c15a43a3f1e --
...
// cleaned up later.
// It returns an error if the transaction could not be added.
// Parameters:
//   ctx - context for logging
//   volTxn - the volume transaction
// Returns:
//   error - the error if the transaction could not be added, nil if the transaction was added
// Example:
//   err := o.AddVolumeTransaction(ctx, volTxn)
//
// -- Doc autogenerated on 2022-06-21. Function hash: e26d3c9af53a81028676844f37108220 --
...
// GetVolumeCreatingTransaction returns a volume transaction that is currently creating a volume.
// It returns an error if the volume transaction cannot be retrieved.
// Parameters:
//   ctx - context for logging
//   config - the volume config
// Returns:
//   storage.VolumeTransaction - the volume transaction
//   error - error if there is any
// Example:
//   txn, err := orchestrator.GetVolumeCreatingTransaction(ctx, config)
//
// -- Doc autogenerated on 2022-06-21. Function hash: 4025deb561dc0aba9e0fa596740664b8 --
...
// GetVolumeTransaction returns a volume transaction by name
// It returns an error if the volume transaction is not found
// Parameters:
//   ctx - context for logging
//   volTxn - the volume transaction
// Returns:
...
//   error - error if there is any
// Example:
//   volTxn, err := orchestrator.GetVolumeTransaction(ctx, "volTxn1")
//
// -- Doc autogenerated on 2022-06-21. Function hash: d8a638429c4b2c3043bb0281d5c34490 --
...
// It returns an error if the volume transaction could not be deleted.
// Parameters:
//   ctx - context for logging
//   volTxn - the volume transaction to delete
// Returns:
//   error - the error if the volume transaction could not be deleted, nil if the volume transaction was deleted
// Example:
//   err := o.DeleteVolumeTransaction(ctx, volTxn)
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 795e32bfe4a5dd11a92ae36c8c1c3e07 --
...
// It returns an error if the cleanup is unsuccessful.
// Parameters:
//   ctx - context for logging
//   err - the error that occurred during the operation
//   backend - the backend where the volume was created
//   vol - the volume that was created
//   volTxn - the volume transaction associated with the operation
//   volumeConfig - the volume config associated with the operation
// Returns:
//   error - the error if the cleanup is unsuccessful, nil if the cleanup is successful
// Example:
//   err := o.addVolumeCleanup(ctx, err, backend, vol, volTxn, volumeConfig)
//
// -- Doc autogenerated on 2022-06-21. Function hash: 10707fd80e961ea473b9d9d8b57018aa --
...
// It returns an error if the volume creation is still ongoing.
// Parameters:
//   ctx - context for logging
//   err - the error if the volume creation is still ongoing
//   backend - the backend
//   pool - the pool
//   volTxn - the volume transaction
//   volumeConfig - the volume config
// Returns:
//   error - the error if the volume creation is still ongoing, nil if the volume creation is successful
// Example:
//   err := o.addVolumeRetryCleanup(ctx, err, backend, pool, volTxn, volumeConfig)
//
// -- Doc autogenerated on 2022-06-21. Function hash: 012cba4286b63bb807e231a47dcbae05 --
...
// importVolumeCleanup is a helper function that cleans up after a failed volume import.
//
// It returns an error if it was unable to clean up all artifacts of the volume import.
//
// Parameters:
//   ctx - context for logging
//   err - the error that occurred during the import, if any
//   volumeConfig - the volume config object for the volume being imported
//   volTxn - the volume transaction object for the volume being imported
// Returns:
//   error - the error if it was unable to clean up all artifacts of the volume import, nil if it was successful
// Example:
//   err := o.importVolumeCleanup(ctx, err, volumeConfig, volTxn)
//
// -- Doc autogenerated on 2022-06-21. Function hash: f5e220ffc92fbb12521834e8dbc438aa --
...
// Returns:
//   storage.VolumeExternal - the volume
//   error - error if there is any
// Example:
//   vol, err := orchestrator.GetVolume(ctx, "volume1")
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 7b809028c4c2d34e481ebd4d9ceadcdf --
...
//   vol, err := orchestrator.getVolume(ctx, "volume1")
//
// -- Doc autogenerated on 2022-06-21. Function hash: a3180f3812fb8b86173ca5c119bc52db --
func (o *TridentOrchestrator) getVolume(
...
// GetDriverTypeForVolume returns the driver type for the specified volume.
// It returns an error if the volume does not exist.
// Parameters:
//   ctx - context for logging
//   vol - the volume
...
//   error - the error if there is any
// Example:
//   driverType, err := o.GetDriverTypeForVolume(ctx, vol)
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: fa6bc896c59ce9a936c5679fd5c658b9 --
...
// exists in memory.
// It returns the driver type and error if there is any.
// Parameters:
//   backendUUID - the UUID of the backend
// Returns:
//   string - the driver type
//   error - error if there is any
// Example:
//   driverType, err := orchestrator.getDriverTypeForVolume("backend1")
//
// -- Doc autogenerated on 2022-06-21. Function hash: 36984fba5929c8a289f6429d6e12a212 --
...
// GetVolumeType returns the volume type of the specified volume.
// It returns an error if the volume type could not be determined.
// Parameters:
//   ctx - context for logging
//   vol - the volume
// Returns:
...
//   error - the error if there is any
// Example:
//   volumeType, err := orchestrator.GetVolumeType(ctx, vol)
//
// -- Doc autogenerated on 2022-06-21. Function hash: 38bae4a9a9ca7f54bb863b2c10a6fe6e --
...
// ListVolumes returns a list of all volumes in the system.
// It returns an error if there is any.
// Parameters:
//   ctx - context for logging
// Returns:
//   volumes - a list of all volumes in the system
//   error - error if there is any
// Example:
//   volumes, err := orchestrator.ListVolumes(ctx)
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 85d4a8042740926b2d85a28566cb3403 --
...
// It returns a slice of snapshots and an error if there is any
// Parameters:
//   volumeName - the name of the volume
// Returns:
//   []*storage.Snapshot - a slice of snapshots
//   error - error if there is any
// Example:
//   snapshots, err := orchestrator.volumeSnapshots("volume1")
//
// -- Doc autogenerated on 2022-06-21. Function hash: 24b97a5ce641e2652b0a580c3bd0f00f --
...
// exists in memory.
// It returns an error if the volume cannot be deleted.
// Parameters:
//   ctx - context for logging
//   volumeName - the name of the volume to delete
// Returns:
//   error - the error if the volume cannot be deleted, nil if the volume is deleted
// Example:
//   err := o.deleteVolume(ctx, "volume1")
//
// -- Doc autogenerated on 2022-06-21. Function hash: 47503a83b9223c8109913559c890d916 --
...
// deleteVolumeFromPersistentStoreIgnoreError deletes a volume from the persistent store.
// It ignores errors if the volume is not found in the store.
// It returns an error if the volume is found in the store but cannot be deleted.
// Parameters:
//   ctx - context for logging
...
//
// -- Doc autogenerated on 2022-06-21. Function hash: c2bcad7a430c67f70288fd3b95d63886 --
...
// It returns an error if the volume is not present in Trident.
// Parameters:
//   ctx - context for logging
//   volumeName - the name of the volume to delete
// Returns:
//   error - the error if the volume is not present in Trident, nil if the volume is present in Trident
// Example:
//   err := o.DeleteVolume(ctx, "volume1")
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: c39825c5fd380766f73ef5c7d8653ca6 --
...
// ListVolumesByPlugin returns a list of volumes by plugin name
// It returns an error if the plugin name is invalid.
// Parameters:
//   ctx - context for logging
...
//   error - error if there is any
// Example:
//   volumes, err := orchestrator.ListVolumesByPlugin(ctx, "plugin1")
//
// -- Doc autogenerated on 2022-06-21. Function hash: 60b8076f3180c5e202ffbeeef30d97b0 --
...
// PublishVolume publishes a volume to a node.
// It returns an error if the volume cannot be published.
// Parameters:
//   ctx - context for logging
//   volumeName - the name of the volume
//   publishInfo - the publish info
// Returns:
//   error - the error if there is any
// Example:
//   err := o.PublishVolume(ctx, "volume1", publishInfo)
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: b7313803948e3a02c08b72fd07dd08d0 --
...
// It returns an error if the volume is not found or if the volume is not published to the node.
// Parameters:
//   ctx - context for logging
//   volumeName - the name of the volume
//   nodeName - the name of the node
// Returns:
//   error - the error if the unpublish failed, nil if the unpublish succeeded
// Example:
//   err := o.UnpublishVolume(ctx, "volume1", "node1")
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 8051f44dc4b6fa47e354a66dd188ad29 --
...
// It returns an error if the volume is not found or if the volume is already mounted.
// Parameters:
//   ctx - context for logging
//   volumeName - the name of the volume
//   mountpoint - the mount point
//   publishInfo - the volume publish info
// Returns:
//   error - the error if the volume is not found or if the volume is already mounted
// Example:
//   err := o.AttachVolume(ctx, "volume1", "/mnt/volume1", &utils.VolumePublishInfo{})
//
// -- Doc autogenerated on 2022-06-21. Function hash: 08cc29fac1ea53ca467a8405912d1e51 --
...
// It returns an error if the volume is not found, the volume is deleting, or the unmount fails.
// Parameters:
//   ctx - context for logging
//   volumeName - the name of the volume
//   mountpoint - the mount point of the volume
// Returns:
//   error - the error if the unmount fails, nil if the unmount succeeds
// Example:
//   err := o.DetachVolume(ctx, "volume1", "/mnt/volume1")
//
// -- Doc autogenerated on 2022-06-21. Function hash: 3ab9993f2717bc59f0937d19e862392c --
...
// It returns an error if the volume state is invalid.
// Parameters:
//   ctx - context for logging
//   volumeName - the name of the volume
//   state - the state of the volume
// Returns:
//   error - the error if the volume state is invalid, nil if the volume state is valid
// Example:
//   err := o.SetVolumeState(ctx, "volume1", storage.VolumeStateOnline)
//
// -- Doc autogenerated on 2022-06-21. Function hash: caf19abab665ec64cd4d73b4922701d6 --
...
// It returns an error if the snapshot cannot be created.
// Parameters:
//   ctx - context for logging
//   snapshotConfig - the snapshot config
// Returns:
//   storage.SnapshotExternal - the snapshot external
//   error - the error if the snapshot cannot be created, nil if the snapshot is created
// Example:
//   snapshotExternal, err := o.CreateSnapshot(ctx, snapshotConfig)
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 9dd9e1ca67aaa0c73abe28dd52f15f10 --
...
//   volTxn - the volume transaction
//   snapConfig - the snapshot config
// Returns:
//   error - the error if the cleanup fails, nil if it succeeds
// Example:
//   err := o.addSnapshotCleanup(ctx, err, backend, snapshot, volTxn, snapConfig)
//
// -- Doc autogenerated on 2022-06-21. Function hash: e813878e10d5a25a278213aa427ec219 --
...
// It returns an error if the snapshot is not found.
// Parameters:
//   ctx - context for logging
//   volumeName - the name of the volume
//   snapshotName - the name of the snapshot
// Returns:
//   storage.SnapshotExternal - the snapshot
//   error - error if there is any
// Example:
//   snapshot, err := orchestrator.GetSnapshot(ctx, "volume1", "snapshot1")
//
// -- Doc autogenerated on 2022-06-21. Function hash: e989ccf35cebc85380ef65b188fb3054 --
...
//   snapshot, err := orchestrator.getSnapshot(ctx, "volume1", "snapshot1")
//
// -- Doc autogenerated on 2022-06-21. Function hash: b64251745b9e500e060496470970c425 --
func (o *TridentOrchestrator) getSnapshot(
	ctx context.Context, volumeName, snapshotName string,
...
// updateSnapshot updates the snapshot in the orchestrator's internal state and in the persistent store.
// It returns the updated snapshot and an error if there is any.
// Parameters:
//   ctx - context for logging
//   snapshot - the snapshot to update
// Returns:
//   storage.Snapshot - the updated snapshot
//   error - error if there is any
// Example:
//   snapshot, err := orchestrator.updateSnapshot(ctx, snapshot)
//
// -- Doc autogenerated on 2022-06-21. Function hash: 325d46cbf1273d5ada4aee5aad9d18fc --
...
// It returns an error if the snapshot could not be deleted.
// Parameters:
//   ctx - context for logging
//   snapshotConfig - the snapshot config
// Returns:
//   error - the error if the snapshot could not be deleted, nil if the snapshot was deleted
// Example:
//   err := o.deleteSnapshot(ctx, snapshotConfig)
//
// -- Doc autogenerated on 2022-06-21. Function hash: 97f2ac0088209154223e59b734eefc83 --
...
// deleteSnapshotFromPersistentStoreIgnoreError deletes a snapshot from the persistent store.
// It returns an error if the snapshot cannot be deleted.
// Parameters:
//   ctx - context for logging
...
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 3d9299843d219334e59de17ceccabde9 --
...
// It returns an error if the snapshot is not found or if the snapshot cannot be deleted
// Parameters:
//   ctx - context for logging
//   volumeName - the name of the volume
//   snapshotName - the name of the snapshot
// Returns:
//   error - the error if the snapshot cannot be deleted, nil if the snapshot is deleted
// Example:
//   err := o.DeleteSnapshot(ctx, "volume1", "snapshot1")
//
// -- Doc autogenerated on 2022-06-21. Function hash: 5c4f78ff92e95a7708153394e239bac0 --
...
// ListSnapshots lists all snapshots in the system.
// It returns a slice of snapshots and an error if there is any.
// Parameters:
//   ctx - context for logging
// Returns:
//   snapshots - a slice of snapshots
//   error - error if there is any
// Example:
//   snapshots, err := o.ListSnapshots(ctx)
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: d08dffcc2af9a6d1f09139abdd3c8e33 --
...
// ListSnapshotsByName returns a list of snapshots by name
// It returns an error if the snapshot name is invalid.
// Parameters:
//   ctx - context for logging
//   snapshotName - the name of the snapshot
// Returns:
...
//   error - error if there is any
// Example:
//   snapshots, err := orchestrator.ListSnapshotsByName(ctx, "snapshot1")
//
// -- Doc autogenerated on 2022-06-21. Function hash: 053cf2d47c2f1434c21a089a0fbeb072 --
...
// ListSnapshotsForVolume returns a list of snapshots for a volume.
// It returns an error if the volume does not exist.
// Parameters:
//   ctx - context for logging
//   volumeName - the name of the volume
...
//   error - error if there is any
// Example:
//   snapshots, err := orchestrator.ListSnapshotsForVolume(ctx, "volume1")
//
// -- Doc autogenerated on 2022-06-21. Function hash: 623db3c5dd57eabbdc24f51e0e61b3a0 --
...
// ReadSnapshotsForVolume returns a list of snapshots for a volume.
// It returns an error if the volume does not exist.
// Parameters:
//   ctx - context for logging
//   volumeName - the name of the volume
// Returns:
//   externalSnapshots - a list of snapshots for the volume
//   error - the error if there is any
// Example:
//   snapshots, err := orchestrator.ReadSnapshotsForVolume(ctx, "volume1")
//
// -- Doc autogenerated on 2022-06-21. Function hash: ccd4d329e169484695ad148c14dfbf12 --
...
// ReloadVolumes reloads the volumes from the backend storage systems.
...
//   error - error if there is any
// Example:
//   err := o.ReloadVolumes(ctx)
//
// -- Doc autogenerated on 2022-06-21. Function hash: 5f5aebb4e5d30c072efd3c62cb1564b0 --
...
// It returns an error if the volume doesn't exist or is being deleted.
// Parameters:
//   ctx - context for logging
//   volumeName - the name of the volume
//   newSize - the new size of the volume
// Returns:
//   error - the error if the resize fails, nil if the resize succeeds
// Example:
//   err := o.ResizeVolume(ctx, "volume1", "10G")
//
// -- Doc autogenerated on 2022-06-21. Function hash: 25114e8d10b21d57c34efa66960065f9 --
...
// caller will take care of both of these. It also assumes that the volume
// exists in memory.
// It returns an error if the resize is unsuccessful.
// Parameters:
//   ctx - context for logging
//   volume - the volume to resize
//   newSize - the new size of the volume
// Returns:
//   error - the error if the resize is unsuccessful, nil if the resize is successful
// Example:
//   err := o.resizeVolume(ctx, volume, newSize)
//
// -- Doc autogenerated on 2022-06-21. Function hash: 11b6c3fdc1fc037db20316277d5938ee --
...
//   volTxn - the volume transaction
// Returns:
//   error - the error if the cleanup fails, nil if the cleanup succeeds
// Example:
//   err := o.resizeVolumeCleanup(ctx, err, vol, volTxn)
//
// -- Doc autogenerated on 2022-06-21. Function hash: a1efa3082b3524d75fbefb8f828baae8 --
...
// Parameters:
//   ctx - context for logging
//   volumeMode - the volume mode
//   accessMode - the access mode
//   protocol - the protocol
// Returns:
//   config.Protocol - the protocol
//   error - the error if the update is invalid, nil if the update is valid
// Example:
//   protocol, err := o.getProtocol(ctx, volumeMode, accessMode, protocol)
//
// -- Doc autogenerated on 2022-06-21. Function hash: 995d04ac2f2247c573571a1b586e3638 --
...
// AddStorageClass adds a new storage class to the orchestrator.
// It returns an error if the storage class already exists or if there is any other problem.
// Parameters:
//   ctx - context for logging
//   scConfig - the storage class config
// Returns:
//   scExternal - the storage class external
//   error - the error if there is any
// Example:
//   scExternal, err := o.AddStorageClass(ctx, scConfig)
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 7dd9fefe2646ed78b243a4d6e24b7079 --
...
// GetStorageClass returns a storage class by name
...
//   error - error if there is any
// Example:
//   sc, err := orchestrator.GetStorageClass(ctx, "sc1")
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 8ea7a3398086c800c66845416db5fef0 --
...
//   error - the error if there is any
// Example:
//   scExternals, err := o.ListStorageClasses(ctx)
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 1d060e4f98ef90c4e6fd57ca995cef7d --
...
//   scName - the name of the storage class
// Returns:
//   error - the error if the storage class could not be deleted, nil if the storage class was deleted
// Example:
//   err := o.DeleteStorageClass(ctx, "storageclass1")
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 7a09523cfb169968ae4a2c6a92941083 --
...
//   err := o.reconcileNodeAccessOnAllBackends(ctx)
//
// -- Doc autogenerated on 2022-06-21. Function hash: 05c9e184edcad2ea38d16deda4378f81 --
...
// reconcileNodeAccessOnBackend updates the node access on the backend.
// It returns an error if the update fails.
// Parameters:
//   ctx - context for logging
//   b - the backend
// Returns:
//   error - the error if the update fails, nil if the update succeeds
// Example:
//   err := o.reconcileNodeAccessOnBackend(ctx, backend)
//
// -- Doc autogenerated on 2022-06-21. Function hash: 32894d9e525f95bbcc5fd8c4512369cf --
...
// already locked
// It returns an error if the reconcileNodeAccessOnBackend is invalid.
// Parameters:
//   ctx - context for logging
//   b - the backend
// Returns:
//   error - the error if the reconcileNodeAccessOnBackend is invalid, nil if the reconcileNodeAccessOnBackend is valid
// Example:
//   err := o.safeReconcileNodeAccessOnBackend(ctx, b)
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: bdb28af6609b6ba01797424052aa73e7 --
...
// Example:
//   o.PeriodicallyReconcileNodeAccessOnBackends()
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: df6e25b990a456580f2a0f5d0d3cf3ff --
...
// It returns an error if the node cannot be added.
// Parameters:
//   ctx - context for logging
//   node - the node to add
//   nodeEventCallback - the callback to invoke when node events occur
// Returns:
//   error - the error if the node could not be added, nil if the node was added successfully
// Example:
//   err := o.AddNode(ctx, node, nodeEventCallback)
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: cd542a37d4abbbf6ed9a5b48b6c67621 --
...
// This function is called when a node is removed from the cluster.
// Example:
//   o.invalidateAllBackendNodeAccess()
//
// -- Doc autogenerated on 2022-06-21. Function hash: 217366d8152ca1accdb52538ef405299 --
...
// handleUpdatedNodePrep validates that the backend update is valid.
// It returns an error if the backend update is invalid.
// Parameters:
//   ctx - context for logging
//   protocol - the protocol for the backend
//   node - the node to update
//   nodeEventCallback - the callback for node events
// Example:
//   err := o.handleUpdatedNodePrep(ctx, "NFS", node, nodeEventCallback)
//
// -- Doc autogenerated on 2022-06-21. Function hash: a834161b9eb4a27bfbb289d967a44a23 --
...
//
// -- Doc autogenerated on 2022-06-21. Function hash: 8adb5cc590b1e328ec136e1d38883212 --
...
//   ctx - context for logging
// Returns:
//   nodes - a list of all nodes in the cluster
//   error - the error if there is any
// Example:
//   nodes, err := o.ListNodes(ctx)
//
// -- Doc autogenerated on 2022-06-21. Function hash: 9bdd3a6d45b81df549bbe35f26aeeb85 --
...
// It returns an error if the node cannot be deleted.
// Parameters:
//   ctx - context for logging
//   nodeName - the name of the node to delete
// Returns:
//   error - the error if the node cannot be deleted, nil if the node is deleted
// Example:
//   err := o.DeleteNode(ctx, "node1")
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: f40063d78d89136a99089e4c9c2b95a7 --
...
//   nodeName - the name of the node to delete
// Returns:
//   error - the error if the node could not be deleted, nil if the node was deleted
// Example:
//   err := o.deleteNode(ctx, "node1")
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 06e53486e08860cbb879e4101d6a9c68 --
func (o *TridentOrchestrator) deleteNode(ctx context.Context, nodeName string) (err error) {
	node, found := o.nodes[nodeName]
	if !found {
		return utils.NotFoundError(fmt.Sprintf("node %s not found", nodeName))
...
// It returns an error if the volume publication is invalid.
// Parameters:
//   ctx - context for logging
//   publication - the volume publication
// Returns:
//   error - the error if the volume publication is invalid, nil if the volume publication is valid
// Example:
//   err := o.AddVolumePublication(ctx, publication)
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: b1668caeb5dc278a0b31431c551b5138 --
...
// It returns an error if the volume publication is not found
// Parameters:
//   ctx - context for logging
//   volumeName - the name of the volume
//   nodeName - the name of the node
// Returns:
//   *utils.VolumePublication - the volume publication
//   error - error if there is any
// Example:
//   publication, err := orchestrator.GetVolumePublication(ctx, "volume1", "node1")
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: b1fc2e7f685a7a38388d3fccd1ae996c --
...
// It returns a list of all volume publications
// Parameters:
//   context.Context - the context for the request
// Returns:
//   publications []*utils.VolumePublication - the list of all volume publications
//   err error - error if there is any
// Example:
//   publications, err := orchestrator.ListVolumePublications(context.Context)
//
// -- Doc autogenerated on 2022-06-21. Function hash: 35b0c9f7716835376b83e5b08e5d914b --
...
//   volumeName - the name of the volume
// Returns:
//   publications - a list of volume publications
//   error - the error if there is any
// Example:
//   publications, err := orchestrator.ListVolumePublicationsForVolume(ctx, "volume1")
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: c53b2c66667305b38b8683919d86e898 --
...
// listVolumePublicationsForVolume returns a list of VolumePublications for a volume
// It returns an error if the volume doesn't exist
// Parameters:
//   ctx - context for logging
//   volumeName - the name of the volume
// Returns:
//   []*utils.VolumePublication - the list of VolumePublications
//   error - error if there is any
// Example:
//   publications, err := orchestrator.listVolumePublicationsForVolume(ctx, "volume1")
//
// -- Doc autogenerated on 2022-06-21. Function hash: 44ca89b928a2986ee3de364f14767cb3 --
func (o *TridentOrchestrator) listVolumePublicationsForVolume(
	_ context.Context, volumeName string,
) (publications []*utils.VolumePublication) {
	publications = []*utils.VolumePublication{}
...
// It returns a list of all volume publications for a given node
// Parameters:
//   ctx - context for logging
//   nodeName - the name of the node
// Returns:
//   publications - the list of volume publications
//   error - error if there is any
// Example:
//   publications, err := orchestrator.ListVolumePublicationsForNode(ctx, "node1")
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 9f0a1519a0a5c2c573b3fe8bd06586ab --
...
// listVolumePublicationsForNode returns a list of volume publications for a node.
// It returns an error if the node name is invalid.
// Parameters:
//   ctx - context for logging
//   nodeName - the name of the node
// Returns:
...
//   publications, err := orchestrator.listVolumePublicationsForNode(ctx, "node1")
//
// -- Doc autogenerated on 2022-06-21. Function hash: 8341522491607108df10aca16d8bc332 --
func (o *TridentOrchestrator) listVolumePublicationsForNode(
...
//   error - the error if there is any
// Example:
//   err := o.DeleteVolumePublication(ctx, volumeName, nodeName)
//
// -- Doc autogenerated on 2022-06-21. Function hash: 91456af5ab89a609eb84c7bcf52644ce --
...
// removeVolumePublicationFromCache removes a volume publication from the cache.
// Parameters:
//   volumeID - the ID of the volume
//   nodeID - the ID of the node
// Example:
//   o.removeVolumePublicationFromCache(volumeID, nodeID)
//
// -- Doc autogenerated on 2022-06-21. Function hash: 0edde50e382bbe37edba87d678249a5a --
...
// updateBackendOnPersistentStore updates the backend information on the persistent store
// It returns an error if the backend update is invalid.
// Parameters:
//   ctx - context for logging
//   backend - the backend to update
//   newBackend - true if this is a new backend, false if this is an update to an existing backend
// Returns:
//   error - the error if there is any
// Example:
//   err := o.updateBackendOnPersistentStore(ctx, backend, true)
//
// -- Doc autogenerated on 2022-06-21. Function hash: 0b8bff03ea76c0c057f27c6fad87a4db --
...
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: c4edd3c8428fe8edb94d43e360c1775a --
...
// replaceBackendAndUpdateVolumesOnPersistentStore updates the backend and volume information in persistent store
// It returns an error if the backend update is invalid.
// Parameters:
//   ctx - context for logging
...
//   error - the error if there is any
// Example:
//   err := o.replaceBackendAndUpdateVolumesOnPersistentStore(ctx, oldBackend, newBackend)
//
// -- Doc autogenerated on 2022-06-21. Function hash: a493110fffae19fac507baac4b3502e7 --
...
// isCRDContext returns true if the context is from a CRD request, false otherwise.
// It returns an error if the context is nil.
// Parameters:
//   ctx - context for logging
// Returns:
//   bool - true if the context is from a CRD request, false otherwise
// Example:
//   crdContext := o.isCRDContext(ctx)
//
// -- Doc autogenerated on 2022-06-21. Function hash: fac4a506fe93e8407310464685f2985d --
...
// It returns an error if the backend does not support mirroring or if there is any other issue
// Parameters:
//   ctx - context for logging
//   backendUUID - the UUID of the backend
//   localVolumeHandle - the handle of the local volume
//   remoteVolumeHandle - the handle of the remote volume
// Returns:
//   error - the error if there is any
// Example:
//   err := o.EstablishMirror(ctx, backendUUID, localVolumeHandle, remoteVolumeHandle)
//
// -- Doc autogenerated on 2022-06-21. Function hash: c1b765518fd5a2d8aba3fd70a859cc19 --
...
// It returns an error if the backend does not support mirroring or if the mirror relationship could not be reestablished
// Parameters:
//   ctx - context for logging
//   backendUUID - the UUID of the backend
//   localVolumeHandle - the handle of the local volume
//   remoteVolumeHandle - the handle of the remote volume
// Returns:
//   error - the error if the mirror relationship could not be reestablished, nil if the mirror relationship was reestablished
// Example:
//   err := o.ReestablishMirror(ctx, backendUUID, localVolumeHandle, remoteVolumeHandle)
//
// -- Doc autogenerated on 2022-06-21. Function hash: 40c0b94acb3698f346989583106795e9 --
...
// It returns a boolean indicating if the operation is waiting for a snapshot to be created
// Parameters:
//   ctx - context for logging
//   backendUUID - the UUID of the backend
//   localVolumeHandle - the handle of the local volume
//   remoteVolumeHandle - the handle of the remote volume
//   snapshotHandle - the handle of the snapshot
// Returns:
//   waitingForSnapshot - a boolean indicating if the operation is waiting for a snapshot to be created
//   error - error if there is any
// Example:
//   waitingForSnapshot, err := orchestrator.PromoteMirror(ctx, backendUUID, localVolumeHandle, remoteVolumeHandle, snapshotHandle)
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 8230ace2dfda41f272c4cbd62ca3e0d2 --
...
// It returns the status of the mirror relationship
// Parameters:
//   ctx - context for logging
//   backendUUID - the UUID of the backend
//   localVolumeHandle - the handle of the local volume
//   remoteVolumeHandle - the handle of the remote volume
// Returns:
//   status - the status of the mirror relationship
//   error - error if there is any
// Example:
//   status, err := orchestrator.GetMirrorStatus(ctx, backendUUID, localVolumeHandle, remoteVolumeHandle)
//
// -- Doc autogenerated on 2022-06-21. Function hash: ed60295af3f0c04c70f60e57d5548a49 --
...
// CanBackendMirror returns a boolean indicating whether the backend is capable of mirroring.
// It returns an error if the backend does not exist.
// Parameters:
//   ctx - context for logging
//   backendUUID - the UUID of the backend
// Returns:
//   capable - boolean indicating whether the backend is capable of mirroring
//   error - error if there is any
// Example:
//   capable, err := orchestrator.CanBackendMirror(ctx, backendUUID)
//
// -- Doc autogenerated on 2022-06-21. Function hash: bc1b19ddd30247a2154212e70860764d --
...
// It returns an error if the release is unsuccessful.
// Parameters:
//   ctx - context for logging
//   backendUUID - the UUID of the backend
//   localVolumeHandle - the handle of the source volume
// Returns:
//   error - the error if the release is unsuccessful, nil if the release is successful
// Example:
//   err := o.ReleaseMirror(ctx, backendUUID, localVolumeHandle)
//
//
// -- Doc autogenerated on 2022-06-21. Function hash: 84e545395def660448d10aaebe86988c --
...
// GetCHAP returns the CHAP information for a volume.
// It returns an error if the volume does not exist.
// Parameters:
//   ctx - context for logging
//   volumeName - the name of the volume
//   nodeName - the name of the node
// Returns:
//   chapInfo - the CHAP information
//   error - the error if there is any
// Example:
//   chapInfo, err := orchestrator.GetCHAP(ctx, "volume1", "node1")
//
// -- Doc autogenerated on 2022-06-21. Function hash: 235deca5df832ab0568e48718d1e814c --

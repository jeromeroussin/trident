...
// recordTransactionTiming records the duration of a transaction
// Parameters:
//   txn: the transaction to record
//   err: the error from the transaction
// Returns:
//   nothing
// Example:
//   recordTransactionTiming(txn, err)
//
// -- Doc autogenerated on 2022-05-26 19:15:06. Function hash: d39f7d63300a6cea90e7402ac7280126 --
...
// transformPersistentState transforms the Trident API objects on the persistent store to the
// current version.
...
//   if err != nil {
//       return fmt.Errorf("couldn't transform persistent state: %v", err)
//   }
//
// -- Doc autogenerated on 2022-05-26 19:15:25. Function hash: c9019c1c63e1407926e156160bcba2b4 --
...
// Bootstrap is called to initialize the orchestrator.
// It returns an error if the orchestrator cannot be initialized.
// Returns:
//   - nil if the orchestrator is initialized successfully
//   - utils.BootstrapError if the orchestrator cannot be initialized
// Example:
//   o := &Orchestrator{}
//   err := o.Bootstrap()
//   if err != nil {
//     if utils.IsBootstrapError(err) {
//       // The orchestrator is not initialized successfully
//     } else {
//       // Some other error occurred
//     }
//   } else {
//     // The orchestrator is initialized successfully
//   }
//
// -- Doc autogenerated on 2022-05-26 19:16:18. Function hash: 04dcb5d2d9ba6669a7ec6f5734590b4e --
...
// bootstrapBackends is called during startup to load backends from the persistent store
// and add them to the orchestrator.
// It returns an error if any backends fail to initialize.
// Parameters:
//    ctx - context
// Returns:
//    error - if any backends fail to initialize
// Example:
//    err := o.bootstrapBackends(ctx)
//
// -- Doc autogenerated on 2022-05-26 19:16:38. Function hash: ace19e963152e034bd3e2ad4e44efd2a --
...
// bootstrapStorageClasses loads the existing storage classes from the backend
// and adds them to the orchestrator.
// It returns an error if the storage classes cannot be retrieved.
// Parameters:
//   ctx - context for the operation
// Returns:
//   error - if the storage classes cannot be retrieved
// Example:
...
//   }
//
// -- Doc autogenerated on 2022-05-26 19:17:04. Function hash: 21a98ba2c9aed0a70ca745011194074a --
...
// bootstrapVolumes is called during startup to load the volumes from the backend store.
// It returns a map of volumes keyed by the volume name.
// Parameters:
//   ctx - the context for the current operation
// Returns:
//   error - if any errors occurred
// Example:
//   volumes, err := o.bootstrapVolumes(ctx)
//   if err != nil {
//       return err
//   }
//
// -- Doc autogenerated on 2022-05-26 19:17:24. Function hash: 713a6e9aafc3998ba2508038c533087d --
...
// bootstrapSnapshots loads all existing snapshots from the backend and adds them to the orchestrator's snapshot map.
// It returns an error if the snapshot cannot be added to the map.
// Parameters:
//    ctx - context
// Returns:
//    error - error if the snapshot cannot be added to the map
// Example:
//    err := o.bootstrapSnapshots(ctx)
//
// -- Doc autogenerated on 2022-05-26 19:17:44. Function hash: 7cc86ef066af5a6d4d4cccf2aaacc362 --
...
// bootstrapVolTxns retrieves volume transaction logs from the persistent store and
// attempts to replay them.
// It returns an error if any of the transactions fail to replay.
// Parameters:
//    ctx - context
// Returns:
//    error - error
// Example:
//    err := bootstrapVolTxns(ctx)
//
// -- Doc autogenerated on 2022-05-26 19:18:10. Function hash: e33c0ea45aaa4a9d8262fd4f04ac4667 --
...
// bootstrapNodes bootstraps the orchestrator with existing nodes.
// It returns an error if any node fails to bootstrap.
// Parameters:
//   ctx - context
// Returns:
//   error - error if any node fails to bootstrap
// Example:
//   err := o.bootstrapNodes(ctx)
//
// -- Doc autogenerated on 2022-05-26 19:18:36. Function hash: 7cfe94c5ecbb68533b741378eaa5ee46 --
...
// bootstrapVolumePublications bootstraps the volume publications from the store
...
//
// -- Doc autogenerated on 2022-05-26 19:19:01. Function hash: feea1b84b5d4a911d16860d0c211b775 --
...
// Parameters:
//   vp - volume publication to be added
// Returns:
//   none
// Example:
//   o.addVolumePublicationToCache(vp)
//
// -- Doc autogenerated on 2022-05-26 19:19:21. Function hash: 6831b1fc734710c782e9132682016e51 --
...
// bootstrap loads the persistent store and initializes the orchestrator
// state.
// It returns an error if the bootstrap fails.
// Parameters:
//     ctx - context for the bootstrap
// Returns:
//     error - error if the bootstrap fails
// Example:
//     err := o.bootstrap(ctx)
//
// -- Doc autogenerated on 2022-05-26 19:19:55. Function hash: bcd99e963177e37d4f93a0ee26ad9890 --
...
// handleFailedTransaction attempts to clean up after a failed transaction.
// This is called when we bootstrap and find a transaction in the persistent
// store that has not been marked as completed.
// It returns an error if it is unable to clean up the transaction.
// Parameters:
//   ctx - context.Context object
//   v - volume transaction object
// Returns:
//   error - error object
// Example:
//   err := o.handleFailedTransaction(ctx, v)
//   if err != nil {
//       return fmt.Errorf("failed to clean up failed transaction: %v", err)
//   }
//
// -- Doc autogenerated on 2022-05-26 19:20:18. Function hash: 39541d951f05903909338f9e59963947 --
...
// resetImportedVolumeName attempts to rename a volume to its original name.
// This is used when a volume is imported and the user wants to rename it.
// It returns an error if the volume could not be found.
// Parameters:
//   ctx - context
//   volume - volume to rename
// Returns:
//   error - error if the volume could not be found
// Example:
//   err := o.resetImportedVolumeName(ctx, volume)
//
// -- Doc autogenerated on 2022-05-26 19:20:47. Function hash: 1033950f7f2014fd8a87dbfb93781f51 --
...
//   o.AddFrontend(rest.NewTridentREST())
//
// -- Doc autogenerated on 2022-05-26 19:21:08. Function hash: be80e16a539796ac4231803c9351df2d --
...
// Parameters:
//    ctx - context
//    name - name of the frontend to get
// Returns:
//    frontend.Plugin - the requested frontend plugin
//    error - an error if one occurs
// Example:
//    fe, err := o.GetFrontend(ctx, "iscsi")
//
// -- Doc autogenerated on 2022-05-26 19:21:25. Function hash: 68c5aa2cdd27528e7d82eb37fe73b601 --
...
// validateBackendUpdate validates that a backend update is allowed.
// It returns an error if the update is not allowed.
// Parameters:
//   oldBackend - the old backend object
//   newBackend - the new backend object
// Returns:
//   error - if the update is not allowed
// Example:
...
//   }
//
// -- Doc autogenerated on 2022-05-26 19:22:18. Function hash: 80555ddd7f23803234d84705cd8e72e3 --
...
// Example:
//   version, err := orchestrator.GetVersion(context)
//   if err != nil {
//     return err
//   }
//
// -- Doc autogenerated on 2022-05-26 19:22:34. Function hash: b3ff28ff24fcdaca9fca3da6aa509290 --
...
// Example:
//   backendUUID, err := o.getBackendUUIDByBackendName("trident")
//   if err != nil {
//       log.Errorf("Could not get backend UUID for 'trident': %v", err)
//   }
//
// -- Doc autogenerated on 2022-05-26 19:22:52. Function hash: 3432223f3c321828475a38387539f630 --
...
// Returns:
//   storage.Backend - the backend object
//   error - nil if the backend was found, error if not
// Example:
//   backend, err := o.getBackendByBackendName(backendName)
//
// -- Doc autogenerated on 2022-05-26 19:23:11. Function hash: 5359cbb6a4e1cb6e05469580d3214563 --
...
// Returns:
//   storage.Backend - the backend based on the configRef
//   error - non-nil if an error occurs
// Example:
//   b, err := o.getBackendByConfigRef("trident-config")
//
// -- Doc autogenerated on 2022-05-26 19:23:28. Function hash: 37e7727af627a51a35149814c5e420af --
...
// getBackendByBackendUUID returns the backend with the specified UUID
// Parameters:
//     backendUUID - the UUID of the backend
// Returns:
//     storage.Backend - the backend with the specified UUID
//     error - any error encountered
// Example:
//     backend, err := o.getBackendByBackendUUID("6b1f6af3-6d1d-43b9-b2e0-a0d8f8e8a5e7")
//
// -- Doc autogenerated on 2022-05-26 19:24:23. Function hash: 5b6c42a570cd7be7efb047a76057cbdd --
...
// GetBackend returns the backend object for the given backend name.
// Parameters:
//    ctx - context for logging
//    backendName - name of the backend
// Returns:
//    backendExternal - backend object
//    err - error if any
// Example:
//    backendExternal, err := orchestrator.GetBackend(ctx, backendName)
//
// -- Doc autogenerated on 2022-05-26 19:24:40. Function hash: 97ea7edf0258bdf4ee62e165318ef219 --
...
// Parameters:
//    ctx - context
//    backendUUID - UUID of the backend to retrieve
// Returns:
//    *storage.BackendExternal - the backend
//    error - any error encountered
// Example:
//    backend, err := orchestrator.GetBackendByBackendUUID(ctx, "f0c4d4a4-4dac-4a1b-b5a0-e53d9c827e3a")
//
// -- Doc autogenerated on 2022-05-26 19:25:07. Function hash: 81d8fa64dc1b3803acd28fbacf4b0287 --
...
// ListBackends returns a list of all backends known to the orchestrator.
// Parameters:
...
//
// -- Doc autogenerated on 2022-05-26 19:25:25. Function hash: 2d98525f51bd5d6b7df26ff8693141e9 --
...
//   error - any error encountered
// Example:
//   err := o.DeleteBackend(ctx, "backend-01")
//
// -- Doc autogenerated on 2022-05-26 19:25:46. Function hash: dac0943d6e46a81a0f9787f5f6ef64f3 --
...
//   backendUUID - UUID of backend
// Returns:
//   error - error if any
// Example:
//   err := o.DeleteBackendByBackendUUID(ctx, "myBackend", "myBackendUUID")
//
// -- Doc autogenerated on 2022-05-26 19:26:10. Function hash: ade56985c915048a2ff8350f698c0690 --
...
// It returns an error if the backend was not found
// Parameters:
//   ctx - context
//   backendName - name of backend
//   backendUUID - UUID of backend
// Returns:
//   error - error if backend was not found
// Example:
//   err := deleteBackendByBackendUUID(ctx, "myBackend", "myBackendUUID")
//
// -- Doc autogenerated on 2022-05-26 19:26:35. Function hash: 2568753d63d7e3305bdc4b1ea5d422de --
...
// It returns the volume and an error if any
// Parameters:
//   ctx - context for the operation
...
//   error - error if any
// Example:
//   volume, err := o.AddVolume(ctx, volumeConfig)
//
// -- Doc autogenerated on 2022-05-26 19:26:54. Function hash: 6b3abc4db9d4558bf39248381f6e73e6 --
...
// CloneVolume clones a volume from an existing volume
// It returns the volume config and a boolean indicating if the volume was created
// Parameters:
//    ctx - context
//    volumeConfig - volume config
// Returns:
//    externalVol - volume external
//    err - error
// Example:
//    cloneVolume, err := o.CloneVolume(ctx, volumeConfig)
//
// -- Doc autogenerated on 2022-05-26 19:27:16. Function hash: 3b05245cf8d531e1b7e704f1d7673887 --
...
// cloneVolumeInitial creates a clone of an existing volume.
// It returns the new volume and an error if one occurred.
// Parameters:
//   ctx - the context
//   volumeConfig - the configuration of the new volume
// Returns:
//   externalVol - the new volume
//   err - any error encountered
// Example:
//   vol, err := orchestrator.cloneVolumeInitial(ctx, volumeConfig)
//   if err != nil {
//       return err
//   }
//
// -- Doc autogenerated on 2022-05-26 19:27:43. Function hash: 3f83112418a823bdafb4b150c3214f8e --
...
// cloneVolumeRetry attempts to clone a volume on a backend.
// It returns the volume and backend if successful, or an error.
// Parameters:
//   ctx - context
//   txn - volume transaction
// Returns:
//   externalVol - volume
//   err - error
// Example:
...
//
// -- Doc autogenerated on 2022-05-26 19:28:03. Function hash: d3195084da6ca49594299f21956d774c --
...
// It returns an error if the volume is not valid
// Parameters:
//   volumeConfig - volume config
//   backend - backend
// Returns:
//   error - error
// Example:
//   err := validateImportVolume(volumeConfig, backend)
//
// -- Doc autogenerated on 2022-05-26 19:28:28. Function hash: 0b239a8ef621ed2e08adbc4c80a11281 --
...
// LegacyImportVolume imports a volume into Trident.
// It returns the volume's external representation.
// Parameters:
//   volumeConfig - volume configuration
//   backendName - name of backend where volume should be imported
//   notManaged - true if Trident should not manage the volume
// Returns:
//   *storage.VolumeExternal - volume's external representation
//   error - error, if any
// Example:
//   volumeExternal, err := orchestrator.LegacyImportVolume(ctx, volumeConfig, backendName, notManaged)
//
// -- Doc autogenerated on 2022-05-26 19:28:57. Function hash: f8c072d23374263c1a818a13bc96fac1 --
...
// It returns the volume's external representation
// Parameters:
//   volumeConfig - configuration for the volume to be imported
//   backendUUID - UUID of the backend where the volume is located
// Returns:
//   externalVol - external representation of the volume
//   err - error if any
// Example:
//   externalVol, err := orchestrator.ImportVolume(ctx, volumeConfig, backendUUID)
//
// -- Doc autogenerated on 2022-05-26 19:29:24. Function hash: caf9bc105080edc2f7b86c15a43a3f1e --
...
// GetVolumeCreatingTransaction returns the volume transaction for the given volume config.
// Parameters:
//   ctx - context for the operation
...
//
// -- Doc autogenerated on 2022-05-26 19:29:49. Function hash: 4025deb561dc0aba9e0fa596740664b8 --
...
// GetVolumeTransaction returns a volume transaction from the store
// Parameters:
//    ctx - context for the request
//    volTxn - volume transaction to return
// Returns:
//    *storage.VolumeTransaction - volume transaction from the store
//    error - error if one occurred
// Example:
//    volTxn, err := o.GetVolumeTransaction(ctx, volTxn)
//
// -- Doc autogenerated on 2022-05-26 19:30:03. Function hash: d8a638429c4b2c3043bb0281d5c34490 --
...
// importVolumeCleanup is called when an error occurs during volume import.
// It attempts to clean up any artifacts of the
// It returns an error if it was unable to clean up.
// Parameters:
//   ctx - context
//   err - error that occurred during import
//   volumeConfig - the volume config
//   volTxn - the volume transaction
// Returns:
//   error - error if it was unable to clean up
// Example:
//   err := importVolumeCleanup(ctx, err, volumeConfig, volTxn)
//   if err != nil {
//       return err
//   }
//
// -- Doc autogenerated on 2022-05-26 19:30:32. Function hash: f5e220ffc92fbb12521834e8dbc438aa --
...
//    error - error object
// Example:
//    volume, err := orchestrator.GetVolume(ctx, "volume1")
//
// -- Doc autogenerated on 2022-05-26 19:30:48. Function hash: 7b809028c4c2d34e481ebd4d9ceadcdf --
...
//    error - error, if any
// Example:
//    volume, err := o.getVolume(ctx, "volume1")
//
// -- Doc autogenerated on 2022-05-26 19:31:02. Function hash: a3180f3812fb8b86173ca5c119bc52db --
...
// GetDriverTypeForVolume returns the driver
// Parameters:
...
//   error
// Example:
//   driverType, err := orchestrator.GetDriverTypeForVolume(vol)
//
// -- Doc autogenerated on 2022-05-26 19:31:17. Function hash: fa6bc896c59ce9a936c5679fd5c658b9 --
...
// GetVolumeType returns the volume
// Parameters:
//   vol *storage.VolumeExternal
//   Returns volumeType config.VolumeType, err error
// Returns:
//   volumeType config.VolumeType
//   err error
// Example:
//   volumeType, err := o.GetVolumeType(vol)
//
// -- Doc autogenerated on 2022-05-26 19:31:54. Function hash: 38bae4a9a9ca7f54bb863b2c10a6fe6e --
...
// Return:
//    []*storage.VolumeExternal - list of volumes
//    error - error, if any
// Example:
//    volumes, err := orchestrator.ListVolumes(context.Background())
//
// -- Doc autogenerated on 2022-05-26 19:32:09. Function hash: 85d4a8042740926b2d85a28566cb3403 --
...
// deleteVolumeFromPersistentStoreIgnoreError deletes the volume from the persistent store,
// ignoring any errors if the volume is not found.
// It returns an error if the volume is found but cannot be deleted.
// Parameters:
//    ctx - context for logging
...
//
// -- Doc autogenerated on 2022-05-26 19:32:28. Function hash: c2bcad7a430c67f70288fd3b95d63886 --
...
//     error - any error encountered
// Example:
//     volumes, err := o.ListVolumesByPlugin(ctx, pluginName)
//
// -- Doc autogenerated on 2022-05-26 19:33:06. Function hash: 60b8076f3180c5e202ffbeeef30d97b0 --
...
//    publishInfo - information about the nodes to publish to
// Returns:
//    error - error if there was a problem publishing the volume
// Example:
//    err := o.PublishVolume(ctx, volumeName, publishInfo)
//
// -- Doc autogenerated on 2022-05-26 19:33:29. Function hash: b7313803948e3a02c08b72fd07dd08d0 --
...
// It returns an error if the volume is not published to the node.
// Parameters:
//   ctx - context
...
//   error - any error encountered
// Example:
//   err := orchestrator.UnpublishVolume(ctx, "volume1", "node1")
//
// -- Doc autogenerated on 2022-05-26 19:33:59. Function hash: 8051f44dc4b6fa47e354a66dd188ad29 --
...
// GetSnapshot returns a snapshot object
// Parameters:
//   ctx - context for the request
//   volumeName - name of the volume
//   snapshotName - name of the snapshot
// Returns:
//   SnapshotExternal object
//   error - error object if operation failed or nil if operation succeeds
// Example:
//   snapshotExternal, err := orchestrator.GetSnapshot(ctx, "MyVolume", "MySnapshot")
//
// -- Doc autogenerated on 2022-05-26 19:35:04. Function hash: e989ccf35cebc85380ef65b188fb3054 --
...
// getSnapshot returns the snapshot with the specified name.
// Parameters:
//   ctx - context for the request
//   volumeName - name of the volume containing the snapshot
//   snapshotName - name of the snapshot to return
// Returns:
//   *storage.SnapshotExternal - the snapshot with the specified name
//   error - any error encountered while retrieving the snapshot
// Example:
//   snapshot, err := o.getSnapshot(ctx, "vol1", "snap1")
//   if err != nil {
//       log.Errorf("Could not get snapshot %v: %v", "snap1", err)
//   } else {
//       log.Infof("Snapshot %v found: %v", "snap1", snapshot)
//   }
//
// -- Doc autogenerated on 2022-05-26 19:35:24. Function hash: b64251745b9e500e060496470970c425 --
...
// It returns the snapshot and an error if one occurred
// Parameters:
//    ctx - context for the request
...
//
// -- Doc autogenerated on 2022-05-26 19:35:40. Function hash: 325d46cbf1273d5ada4aee5aad9d18fc --
...
// that may occur if the snapshot is not present in the store.
// It returns an error if the snapshot is present in the store but cannot be deleted.
// Parameters:
//    ctx - context
//    snapshot - snapshot to delete
// Return:
//    error - if the snapshot is present in the store but cannot be deleted
// Example:
//    err := deleteSnapshotFromPersistentStoreIgnoreError(ctx, snapshot)
//    if err != nil {
//       // Unable to delete snapshot from persistent store.
//    }
//
// -- Doc autogenerated on 2022-05-26 19:36:01. Function hash: 3d9299843d219334e59de17ceccabde9 --
...
// Returns:
//    []*storage.SnapshotExternal - A list of snapshots
//    error - Any error encountered
// Example:
//    snapshots, err := orchestrator.ListSnapshots(context.Background())
//
// -- Doc autogenerated on 2022-05-26 19:36:26. Function hash: d08dffcc2af9a6d1f09139abdd3c8e33 --
...
// ListSnapshotsByName returns a list of snapshots with the given name
// Parameters:
//    ctx - context.Context object for the API call
//    snapshotName - name of the snapshot to list
// Returns:
//    list of snapshots with the given name
//    error - if there was an error listing the snapshots
// Example:
//    snapshots, err := orchestrator.ListSnapshotsByName(ctx, "mySnapshot")
//
// -- Doc autogenerated on 2022-05-26 19:36:47. Function hash: 053cf2d47c2f1434c21a089a0fbeb072 --
...
//   volumeName - name of the volume
// Returns:
//   []*storage.SnapshotExternal - list of SnapshotExternal objects
//   error - error object
// Example:
//   snapshots, err := c.ListSnapshotsForVolume(ctx, "vol1")
//
// -- Doc autogenerated on 2022-05-26 19:37:11. Function hash: 623db3c5dd57eabbdc24f51e0e61b3a0 --
...
// ReadSnapshotsForVolume returns a list of snapshots for the given volume.
// Parameters:
//     ctx - context for logging
//     volumeName - name of the volume to query
// Returns:
//     []*storage.SnapshotExternal - a list of snapshots for the given volume
//     error - error, if any
// Example:
//     externalSnapshots, err := tridentOrchestrator.ReadSnapshotsForVolume(ctx, volumeName)
//
// -- Doc autogenerated on 2022-05-26 19:37:28. Function hash: ccd4d329e169484695ad148c14dfbf12 --
...
// ReloadVolumes is called when the volumes have changed.
...
//
// -- Doc autogenerated on 2022-05-26 19:37:58. Function hash: 5f5aebb4e5d30c072efd3c62cb1564b0 --
...
// It returns the storage class, or an error if the storage class already exists.
// Parameters:
//     ctx - context (for logging)
//     scConfig - the storage class configuration
// Return:
//     *storageclass.External - the storage class
//     error - error, if any
// Example:
//     sc, err := o.AddStorageClass(ctx, &storageclass.Config{Name: "sc1"})
//
// -- Doc autogenerated on 2022-05-26 19:38:27. Function hash: 7dd9fefe2646ed78b243a4d6e24b7079 --
...
// GetStorageClass returns the storage class with the specified name
// Parameters:
//    ctx - Context for the request
//    scName - Name of the storage class to retrieve
// Returns:
//    *storageclass.External - Storage class object
//    error - Any errors encountered
// Example:
//    sc, err := orchestrator.GetStorageClass(ctx, "scName")
//    if err != nil {
//        return err
//    }
//
// -- Doc autogenerated on 2022-05-26 19:38:44. Function hash: 8ea7a3398086c800c66845416db5fef0 --
...
//   ctx - context for the operation
// Returns:
//   a list of storage class objects
//   an error or nil if successful
// Example:
//   storageClasses, err := orchestrator.ListStorageClasses(ctx)
//
// -- Doc autogenerated on 2022-05-26 19:39:02. Function hash: 1d060e4f98ef90c4e6fd57ca995cef7d --
...
// Returns:
//   error - error if the storage class could not be deleted
// Example:
//   err := orchestrator.DeleteStorageClass(ctx, "scName")
//   if err != nil {
//       return err
//   }
//
// -- Doc autogenerated on 2022-05-26 19:39:40. Function hash: 7a09523cfb169968ae4a2c6a92941083 --
...
//    ctx - context for logging
// Return:
//    error - error if any backend fails to reconcile
// Example:
//    err := o.reconcileNodeAccessOnAllBackends(ctx)
//    if err != nil {
//       log.Error("Error during node access reconciliation")
//    }
//
// -- Doc autogenerated on 2022-05-26 19:39:59. Function hash: 05c9e184edcad2ea38d16deda4378f81 --
...
// reconcileNodeAccessOnBackend reconciles node access for a backend
...
//   }
//
// -- Doc autogenerated on 2022-05-26 19:40:37. Function hash: 32894d9e525f95bbcc5fd8c4512369cf --
...
//   nodeEventCallback - callback function to call when a node event occurs
// Returns:
//   error - any error encountered
// Example:
...
//   }
//
// -- Doc autogenerated on 2022-05-26 19:41:13. Function hash: cd542a37d4abbbf6ed9a5b48b6c67621 --
...
//
// -- Doc autogenerated on 2022-05-26 19:41:26. Function hash: 217366d8152ca1accdb52538ef405299 --
...
//   node - node for which node prep is being reported
//   nodeEventCallback - callback to invoke to report node prep status
// Returns:
//   none
// Example:
//   o.handleUpdatedNodePrep(ctx, "NFS", node, nodeEventCallback)
//
// -- Doc autogenerated on 2022-05-26 19:42:06. Function hash: a834161b9eb4a27bfbb289d967a44a23 --
...
// GetNode returns the node object from the orchestrator
// Parameters:
//   ctx - context for logging
//   nName - name of the node to retrieve
// Returns:
//   node - the node object from the orchestrator
//   err - any error encountered
// Example:
...
//
// -- Doc autogenerated on 2022-05-26 19:42:35. Function hash: 8adb5cc590b1e328ec136e1d38883212 --
...
//   err - error, if any
// Example:
//   nodes, err := tridentOrchestrator.ListNodes(context)
//
// -- Doc autogenerated on 2022-05-26 19:42:59. Function hash: 9bdd3a6d45b81df549bbe35f26aeeb85 --
...
//
// -- Doc autogenerated on 2022-05-26 19:43:18. Function hash: f40063d78d89136a99089e4c9c2b95a7 --
...
// Returns:
//   error - error if the node does not exist
// Example:
//   err := o.deleteNode(ctx, nodeName)
//
// -- Doc autogenerated on 2022-05-26 19:43:41. Function hash: 06e53486e08860cbb879e4101d6a9c68 --
...
// listVolumePublicationsForVolume returns all publications for a volume
// Parameters:
//   volumeName: name of the volume
// Returns:
//   []*utils.VolumePublication: list of publications for the volume
// Example:
//   publications := o.listVolumePublicationsForVolume(ctx, volumeName)
//
// -- Doc autogenerated on 2022-05-26 19:43:56. Function hash: 44ca89b928a2986ee3de364f14767cb3 --
...
// listVolumePublicationsForNode returns a list of volume publications for the given node
// Parameters:
//     nodeName - the name of the node
// Return:
//     a list of volume publications for the given node
// Example:
//     publications, err := o.listVolumePublicationsForNode(nodeName)
//
// -- Doc autogenerated on 2022-05-26 19:44:12. Function hash: 8341522491607108df10aca16d8bc332 --
...
// Parameters:
//   volumeID - the volume's unique ID
//   nodeID - the node's unique ID
// Returns:
//   None
// Example:
//   o.removeVolumePublicationFromCache("volume-123", "node-123")
//
// -- Doc autogenerated on 2022-05-26 19:44:35. Function hash: 0edde50e382bbe37edba87d678249a5a --
...
//   newBackend - whether this is a new backend or an existing one
// Returns:
//   error - error if the backend could not be updated
// Example:
//   if err := o.updateBackendOnPersistentStore(ctx, backend, newBackend); err != nil {
//       return err
//   }
//
// -- Doc autogenerated on 2022-05-26 19:45:16. Function hash: 0b8bff03ea76c0c057f27c6fad87a4db --
...
//   }
//
// -- Doc autogenerated on 2022-05-26 19:45:40. Function hash: c4edd3c8428fe8edb94d43e360c1775a --
...
// It returns an error if the backend or volume information could not be updated.
// Parameters:
//     ctx - context
//     origBackend - original backend
//     newBackend - new backend
// Return:
//     error - error if the backend or volume information could not be updated
// Example:
//     err := o.replaceBackendAndUpdateVolumesOnPersistentStore(ctx, origBackend, newBackend)
//
// -- Doc autogenerated on 2022-05-26 19:46:10. Function hash: a493110fffae19fac507baac4b3502e7 --
...
// isCRDContext returns true if the context is from a CRD request
// Parameters:
//    ctx - the context
// Returns:
//    bool - true if the context is from a CRD request
// Example:
//    ctx := context.WithValue(context.Background(), ContextKeyRequestSource, ContextSourceCRD)
//    isCRD := o.isCRDContext(ctx)
//
// -- Doc autogenerated on 2022-05-26 19:47:01. Function hash: fac4a506fe93e8407310464685f2985d --
...
// CanBackendMirror returns whether the backend is capable of mirroring
// Parameters:
//   context - The context
//   backendUUID - The backend UUID
// Returns:
//   capable - Whether the backend is mirror capable
//   err - Any errors
// Example:
//   capable, err := trident.CanBackendMirror(ctx, backendUUID)
//
// -- Doc autogenerated on 2022-05-26 19:47:24. Function hash: bc1b19ddd30247a2154212e70860764d --
...
// GetCHAP retrieves the CHAP information for a volume
// It returns the CHAP information for the volume, or an error if the volume does not exist
// Parameters:
//    ctx - context
//    volumeName - name of the volume
//    nodeName - name of the node
// Returns:
//    chapInfo - CHAP information for the volume
//    err - error if any
// Example:
//    chapInfo, err := orchestrator.GetCHAP(ctx, "vol01", "node01")
//
// -- Doc autogenerated on 2022-05-26 19:47:55. Function hash: 235deca5df832ab0568e48718d1e814c --

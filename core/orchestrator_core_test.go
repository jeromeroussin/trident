...
// Parameters:
//   t: the test object
//   o: the orchestrator to clean up
// Returns:
//   None
// Example:
//   cleanup(t, o)
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// diffConfig compares two structs and returns a list of differences
// between them.
// It returns an empty list if there are no differences.
//
// The fieldToSkip parameter is optional and can be used to skip a field
// in the comparison.
// Parameters:
//   expected: the expected struct
//   got: the actual struct
//   fieldToSkip: the name of a field to skip in the comparison
// Returns:
//   a list of differences
// Example:
//   diffs := diffConfig(expected, got, "")
//   diffs := diffConfig(expected, got, "FieldToSkip")
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// diffExternalBackends compares two external backends and logs any differences
// Parameters:
//   t: testing.T object
...
//   None
// Example:
//   diffExternalBackends(t, expected, got)
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// runDeleteTest runs a single test from the deleteTest suite.
// Parameters:
//    t: the test object
//    d: the deleteTest to run
//    orchestrator: the orchestrator to use
// Returns:
//    nothing
// Example:
//    runDeleteTest(t, tests[0], orchestrator)
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
func runDeleteTest(
...
// getOrchestrator is a helper function for tests that need to create an orchestrator.
// It will create a new orchestrator, bootstrap it, and return it.
// It returns the orchestrator and a cleanup function that should be called when the test is done.
// Parameters:
//   t: the test object
// Returns:
//   o: the orchestrator
...
// validateStorageClass validates that the storage class has the expected pools.
// Parameters:
//   t: The test object.
//   o: The orchestrator.
//   name: The name of the storage class.
//   expected: The expected pools.
// Returns:
//   None.
// Example:
//   validateStorageClass(t, o, "sc1", []*tu.PoolMatch{
//     tu.NewPoolMatch("be1", "pool1"),
//   })
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// TestCloneVolumes tests the CloneVolume functionality.
// It checks that the clone is placed in the same backend as the source volume,
// and that the clone is registered in the store.
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// addBackend adds a backend with the specified name and protocol.
// Parameters:
//   t *testing.T: the test object
//   orchestrator *TridentOrchestrator: the orchestrator object
//   backendName string: the name of the backend to add
//   backendProtocol config.Protocol: the protocol of the backend to add
// Returns:
//   None
// Example:
//   addBackend(t, orchestrator, "mockBackend", config.File)
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
func addBackend(
...
// captureOutput captures the output of the provided function and returns it as a string
// It returns an empty string if the function doesn't log anything
// Parameters:
//    f - function to capture output of
// Returns:
...
// TestBackendUpdateAndDelete tests the ability to update and delete backends.
// It checks that the orchestrator correctly updates storage classes and
// volumes when a backend is updated. It also checks that the orchestrator
// correctly offlines a backend when it is deleted.
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// Parameters:
//   t: the test object
//   debugTraceFlags: a map of debug trace flags to enable
// Returns:
//   nothing
// Example:
//   backendPasswordsInLogsHelper(t, map[string]bool{"backend": true})
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// when the method is not specified.
// It checks that backend passwords are logged when the method is specified.
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// TestBootstrapSnapshotMissingVolume tests that a snapshot in the missing_volume state is bootstrapped
// correctly and can be deleted.
// It checks that the snapshot is in the missing_volume state and that it can be deleted.
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// TestBootstrapSnapshotMissingBackend tests that a snapshot in the missing_backend state is
...
// TestBootstrapVolumeMissingBackend tests that a volume in the missing_backend state can be
// bootstrapped and deleted.
// It checks that the volume is in the missing_backend state and that it can be deleted.
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// TestBackendCleanup tests that offline backends are cleaned up during bootstrap.
// It checks that online backends are not cleaned up during bootstrap.
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// It checks that the backend is loaded correctly and that it can be loaded
// after a restart.
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// prepRecoveryTest prepares a backend and storage class for testing
// recovery test functionality.
// Parameters:
//   t: Test object
//   orchestrator: Trident orchestrator
//   backendName: Name of the backend to create
//   scName: Name of the storage class to create
// Returns:
//   None
// Example:
//   prepRecoveryTest(t, orchestrator, "backend", "sc")
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// runRecoveryTests runs a set of recovery tests.
//
// Each test is a volume transaction that's been partially completed.
// The test is run by creating a new orchestrator, which should
// recover from the transaction and then clean up after itself.
// Parameters:
//   t: the test object
//   orchestrator: the orchestrator to use for the test
//   backendName: the name of the backend to use for the test
//   op: the operation to perform
//   testCases: a list of recoveryTest objects, each of which contains
//     a VolumeConfig and a name for the test.
// Returns:
//   nothing
// Example:
//   runRecoveryTests(t, orchestrator, "be-1", storage.AddVolume, []recoveryTest{
//     {
//       name: "Test 1",
//       volumeConfig: &storage.VolumeConfig{
//         Name: "vol-1",
//         Size: "1GiB",
//         Attributes: map[string]sa.Request{
//           "fakeattrib": sa.NewStringRequest("fakeval"),
//         },
//         Internal: true,
...
// It checks that the volume is properly created and destroyed.
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// TestAddVolumeWithTMRNonONTAPNAS tests that a volume with a TMR relationship
// to a non-ONTAP NAS backend fails to be added
// It checks that the error message is as expected
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// TestDeleteVolumeRecovery tests the recovery of a volume delete.
// It checks that the volume is removed from the orchestrator, but not destroyed.
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// generateSnapshotConfig returns a SnapshotConfig object with the specified name and volume
// Parameters:
//   name - the name of the snapshot
//   volumeName - the name of the volume to snapshot
//   volumeInternalName - the internal name of the volume to snapshot
// Returns:
//   SnapshotConfig object
// Example:
//   snapshotConfig := generateSnapshotConfig("snapshot-name", "volume-name", "volume-internal-name")
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// runSnapshotRecoveryTests runs a set of tests to verify that the orchestrator
// is able to recover from a partially completed snapshot addition.
// Parameters:
//   t: The test object
//   orchestrator: The orchestrator object to use for the tests
//   backendName: The name of the backend to use for the tests
//   op: The operation to test (AddSnapshot or DeleteSnapshot)
//   testCases: A slice of recoveryTest objects describing the tests to run
// Returns:
//   None
// Example:
//   runSnapshotRecoveryTests(t, orchestrator, "fake", storage.DeleteSnapshot,
//      []recoveryTest{
//          {
...
// TestAddSnapshotRecovery tests the recovery of AddSnapshot transactions.
// It checks that the snapshot is deleted if the transaction was fully committed,
// and that the snapshot is not deleted if the transaction was only partially committed.
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// TestDeleteSnapshotRecovery tests that snapshot delete transactions are properly
// recovered.
// It checks that the snapshot is not deleted if the snapshot exists, and that the
// snapshot is deleted if the snapshot does not exist.
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// TestFirstVolumeRecovery tests that the first volume in a backend is recovered correctly
// It checks that the volume is destroyed and recreated
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// TestOrchestratorNotReady tests the behavior of the orchestrator when it is not ready.
// It checks that all the orchestrator methods return an error.
...
// importVolumeSetup is a helper function for tests that need to
// It returns an orchestrator and a volume config
// Parameters:
//   t - the test object
...
//   importOriginalName - the original name of the volume to import
//   backendProtocol - the protocol of the backend to create
// Returns:
//   *TridentOrchestrator - the orchestrator object
//   *storage.VolumeConfig - the volume config object
// Example:
//   orchestrator, volumeConfig := importVolumeSetup(t, "backend1", "sc1", "vol1", "originalVolName", config.File)
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// TestImportVolumeFailures tests that importVolumeCleanup is called when
// importVolumeSetup fails
// It checks that the volume is renamed to the original name and that the
// persisted state is cleaned up
// It returns an error if the volume is not renamed or if the persisted state
// is not cleaned up
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// It checks that the volume is imported with the expected name and that it is persisted
// if it is managed.
// It returns the volumeExternal and the volumeConfig.
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// TestImportVolume tests the ImportVolume method
// It checks that the volume is persisted and that the internal name is correct
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// - The volume is not compatible with the access mode
// - The volume is not compatible with the volume mode
// - The volume is not compatible with the protocol
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// It checks for the following error conditions:
// - Protocol is not compatible with the backend
// - FileSystem is not compatible with the backend
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// TestAddVolumePublication tests adding a volume publication to the orchestrator
// It checks that the orchestrator calls the store client with the correct object,
// and that the orchestrator's cache is updated correctly
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// TestAddVolumePublicationError tests that the orchestrator returns an error when the store client returns an error
// when adding a volume publication
// It checks that the orchestrator's cache is not updated
// It returns an error
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// It checks that the correct volume publication is returned
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// TestGetVolumePublicationError tests the GetVolumePublication function when an error is returned
// It checks that the correct error is returned
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// TestListVolumePublicationsNotFound tests the case where there are no volume publications
// in the persistent store
// It checks that the returned list is empty and that there is no error
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// TestListVolumePublicationsError tests that ListVolumePublications returns an error if the
// orchestrator is in an error state
// It checks that the orchestrator returns an error if it is in an error state
// It checks that the orchestrator returns an empty list of publications
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// TestListVolumePublicationsForVolumeNotFound tests the ListVolumePublicationsForVolume method
// when the volume is not found
...
// It checks that the orchestrator returns an error when it is in a bootstrap error state
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// TestListVolumePublicationsForNodeNotFound tests that ListVolumePublicationsForNode returns an empty list when
// the node is not found.
// It checks that the orchestrator does not return an error when the node is not found.
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// TestListVolumePublicationsForNodeError tests the case where there is an error
// during bootstrap.
...
// TestDeleteVolumePublicationNotFound tests that an error is returned when a volume publication is not found
// It checks that the correct error
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// handles the case where a volume publication is not found in the persistence
// layer.
...
// TestDeleteVolumePublicationError tests the error path for deleting a volume publication
// It checks that the error is returned and that the cache is not updated
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// It checks that an error is returned if the node does not exist
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// TestListNodes tests that the orchestrator can list nodes
// It checks that the orchestrator returns the correct nodes
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// The order of the nodes in the slices is not considered.
// It returns true if the slices contain the same nodes.
// Parameters:
//     x, y - the slices to compare
// Returns:
//     bool - true if the slices contain the same nodes
// Example:
//     x := []*utils.Node{n1, n2, n3}
//     y := []*utils.Node{n3, n2, n1}
//     unorderedNodeSlicesEqual(x, y) // returns true
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// TestSnapshotVolumes tests snapshotting volumes.
// It checks that the snapshot is created and deleted correctly.
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// It checks for all the valid and invalid combinations of volumeMode, accessMode and protocol
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// TestGetBackendByBackendUUID tests the GetBackendByBackendUUID function
...
// It checks that the backend is set to deleting, set offline, and terminated
// It also checks that the backend is removed from the orchestrator's backend map
...
// It checks that the correct backend is called and that the volume is updated in the persistent store
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// orchestrator fails to update the persistent store after a successful publish
// operation.
// It checks that the orchestrator returns the error from the persistent store
// client.
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// It checks that the correct backend is called and that the
// returned chap info is correct
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
...
// TestGetCHAPFailure tests the failure path of the GetCHAP function
// It checks that the correct error is returned
//
// -- Doc autogenerated on 2022-05-12 18:24:02.136775 --
